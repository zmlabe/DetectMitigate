"""
Calculate trend for OS for the calculated swup_toax but just for the CONUS
...
barlim2 = np.arange(-30,31,10)
limit2 = np.arange(-30,30.1,0.1)
label = r'\textbf{swup_toa [W/m$^{2}$]}' 
...
plt.savefig(directoryfigure + 'GWL-%s_%s_%s_CONUS.png' % (selectGWLn,'swup_toa',seasons[0]),dpi=300)
