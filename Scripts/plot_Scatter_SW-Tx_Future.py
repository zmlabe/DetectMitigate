"""
Examine relationship between SWup and heatwaves
...
plt.ylabel(r'\textbf{swup_toa Anomaly [W/m2]}',fontsize=11,color='dimgrey')
...
plt.tight_layout()
plt.savefig(directoryfigure + 'Scatter_swup_toa-Tx90_OS.png',dpi=300)
