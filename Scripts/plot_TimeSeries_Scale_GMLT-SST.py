"""
Calculate timeseries of Global means of land temperature and scaled for SST
...
plt.xlabel(r'\textbf{LAND relative to 1921-1950 [$^{\circ}$C] - %s}' % reg_name,fontsize=7,color='k')
plt.ylabel(r'\textbf{SST relative to 1921-1950 [$^{\circ}$C] - %s}' % reg_name,fontsize=7,color='k')

plt.tight_layout()
plt.savefig(directoryfigure + 'TimeSeries_Scale_GM%s-GMSST_%s_%s_byDecade.png' % (variqAir,seasons[0],reg_name),dpi=300)
