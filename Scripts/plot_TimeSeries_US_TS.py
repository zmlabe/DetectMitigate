"""
Calculate timeseries of CONUS mean of TS
...
plt.ylabel(r'\textbf{Skin Temperature [$^{\circ}$C; 1921-1950; %s; %s]}' % (seasons[0],reg_name),
            fontsize=7,color='k')

plt.tight_layout()
plt.savefig(directoryfigure + 'TimeSeries_CONUS_TS_historicalbaseline_%s_%s.png' % (seasons[0],reg_name),dpi=300)
