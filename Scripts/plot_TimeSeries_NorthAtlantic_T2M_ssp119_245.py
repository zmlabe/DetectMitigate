"""
First version of classification problem for emission scenario using SSP119 and
SSP245
...
plt.tight_layout()
plt.savefig(directoryfigure + 'NorthAtlantic_%s_EmissionScenarios_%s_ssp119_245.png' % (variq,monthlychoice),dpi=300)
...
plt.tight_layout()
plt.savefig(directoryfigure + 'NorthNorthAtlantic_%s_EmissionScenarios_%s_ssp119_245.png' % (variq,monthlychoice),dpi=300)
