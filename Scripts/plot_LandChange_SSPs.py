...
epochsize = 10
simulations = ['SPEAR_MED','SPEAR_MED_Scenario','SPEAR_MED_SSP534OS_10ye']
scenarios = ['SSP585','SSP534OS','SSP534OS_10ye']

modelnames = ['SPEAR_MED_SSP585','SPEAR_MED_SSP534OS','SPEAR_MED_SSP534OS_10ye']
...
preparedata = [diffcrop_585,diffcrop_os,diffcrop_os10ye,
                diffntrl_585,diffntrl_os,diffntrl_os10ye,
                diffpast_585,diffpast_os,diffpast_os10ye,
                diffscnd_585,diffscnd_os,diffscnd_os10ye]
