"""
Examine relationship between SHFLX and heatwaves with SSP585
...
plt.ylabel(r'\textbf{SHFLX Anomaly [W/m2] - %s}' % reg_name_vari,fontsize=11,color='dimgrey')
...
plt.tight_layout()
plt.savefig(directoryfigure + 'Scatter_SHFLX-Tn90_OS_%s_ssp585.png' % reg_name_vari,dpi=300)
