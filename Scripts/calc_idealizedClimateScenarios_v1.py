...
### Hypothetical decrease 2030
yearq_S2030 = np.where(yearstotal == 2030)[0][0]*12
p1_S2030 = [yearq_S2030+1,co2_spear[yearq_S2030]]
p2_S2030 = [len(yearstotal_extend)*12,co2_spear[0]+(co2_spear[yearq_S2030] - co2_spear[yearq_S2020])]
length_S2030 = (len(yearstotal_extend)*12) - yearq_S2030
p3_S2030 = [yearq_S2030+120,co2_spear[yearq_S2030+120]]
x_S2030, y_S2030= draw_curve(p1_S2030, p2_S2030, p3_S2030, length_S2030)

### Hypothetical decrease 2040
yearq_S2040 = np.where(yearstotal == 2040)[0][0]*12
p1_S2040 = [yearq_S2040+1,co2_spear[yearq_S2040]]
p2_S2040 = [len(yearstotal_extend)*12,co2_spear[0]+(co2_spear[yearq_S2040] - co2_spear[yearq_S2020])]
...
### Hypothetical decrease 2050
yearq_S2050 = np.where(yearstotal == 2050)[0][0]*12
p1_S2050 = [yearq_S2050+1,co2_spear[yearq_S2050]]
p2_S2050 = [len(yearstotal_extend)*12,co2_spear[0]+(co2_spear[yearq_S2050] - co2_spear[yearq_S2020])]
length_S2050 = (len(yearstotal_extend)*12) - yearq_S2050
p3_S2050 = [yearq_S2050+120,co2_spear[yearq_S2050+120]]
x_S2050, y_S2050= draw_curve(p1_S2050, p2_S2050, p3_S2050, length_S2050)

### Hypothetical decrease 2060
yearq_S2060 = np.where(yearstotal == 2060)[0][0]*12
p1_S2060 = [yearq_S2060+1,co2_spear[yearq_S2060]]
p2_S2060 = [len(yearstotal_extend)*12,co2_spear[0]+(co2_spear[yearq_S2060] - co2_spear[yearq_S2020])]
length_S2060 = (len(yearstotal_extend)*12) - yearq_S2060
p3_S2060 = [yearq_S2060+120,co2_spear[yearq_S2060+120]]
x_S2060, y_S2060= draw_curve(p1_S2060, p2_S2060, p3_S2060, length_S2060)

### Hypothetical decrease 2070
yearq_S2070 = np.where(yearstotal == 2070)[0][0]*12
p1_S2070 = [yearq_S2070+1,co2_spear[yearq_S2070]]
p2_S2070 = [len(yearstotal_extend)*12,co2_spear[0]+(co2_spear[yearq_S2070] - co2_spear[yearq_S2020])]
length_S2070 = (len(yearstotal_extend)*12) - yearq_S2070
p3_S2070 = [yearq_S2070+120,co2_spear[yearq_S2070+(10*12)]]
x_S2070, y_S2070= draw_curve(p1_S2070, p2_S2070, p3_S2070, length_S2070)
                             
### Hypothetical decrease 2080
yearq_S2080 = np.where(yearstotal == 2080)[0][0]*12
p1_S2080 = [yearq_S2080+1,co2_spear[yearq_S2080]]
p2_S2080 = [len(yearstotal_extend)*12,co2_spear[0]+(co2_spear[yearq_S2080] - co2_spear[yearq_S2020])]
length_S2080 = (len(yearstotal_extend)*12) - yearq_S2080
p3_S2080 = [yearq_S2080+120,co2_spear[yearq_S2080+(5*12)]]
x_S2080, y_S2080= draw_curve(p1_S2080, p2_S2080, p3_S2080, length_S2080)
...
### Hypothetical decrease 2030
yearq_S2030 = np.where(yearstotal == 2030)[0][0]*12
p1_S2030_ch4 = [yearq_S2030+1,ch4_spear[yearq_S2030]]
p2_S2030_ch4 = [len(yearstotal_extend)*12,ch4_spear[0]+(ch4_spear[yearq_S2030] - ch4_spear[yearq_S2020])]
length_S2030_ch4 = (len(yearstotal_extend)*12) - yearq_S2030
p3_S2030_ch4 = [yearq_S2030+120,ch4_spear[yearq_S2030+120]]
x_S2030_ch4, y_S2030_ch4= draw_curve(p1_S2030_ch4, p2_S2030_ch4, p3_S2030_ch4, length_S2030_ch4)

### Hypothetical decrease 2040
yearq_S2040 = np.where(yearstotal == 2040)[0][0]*12
p1_S2040_ch4 = [yearq_S2040+1,ch4_spear[yearq_S2040]]
p2_S2040_ch4 = [len(yearstotal_extend)*12,ch4_spear[0]+(ch4_spear[yearq_S2040] - ch4_spear[yearq_S2020])]
...
### Hypothetical decrease 2050
yearq_S2050 = np.where(yearstotal == 2050)[0][0]*12
p1_S2050_ch4 = [yearq_S2050+1,ch4_spear[yearq_S2050]]
p2_S2050_ch4 = [len(yearstotal_extend)*12,ch4_spear[0]+(ch4_spear[yearq_S2050] - ch4_spear[yearq_S2020])]
length_S2050_ch4 = (len(yearstotal_extend)*12) - yearq_S2050
p3_S2050_ch4 = [yearq_S2050+120,ch4_spear[yearq_S2050+120]]
x_S2050_ch4, y_S2050_ch4= draw_curve(p1_S2050_ch4, p2_S2050_ch4, p3_S2050_ch4, length_S2050_ch4)

### Hypothetical decrease 2060
yearq_S2060 = np.where(yearstotal == 2060)[0][0]*12
p1_S2060_ch4 = [yearq_S2060+1,ch4_spear[yearq_S2060]]
p2_S2060_ch4 = [len(yearstotal_extend)*12,ch4_spear[0]+(ch4_spear[yearq_S2060] - ch4_spear[yearq_S2020])]
length_S2060_ch4 = (len(yearstotal_extend)*12) - yearq_S2060
p3_S2060_ch4 = [yearq_S2060+120,ch4_spear[yearq_S2060+120]]
x_S2060_ch4, y_S2060_ch4= draw_curve(p1_S2060_ch4, p2_S2060_ch4, p3_S2060_ch4, length_S2060_ch4)

### Hypothetical decrease 2070
yearq_S2070 = np.where(yearstotal == 2070)[0][0]*12
p1_S2070_ch4 = [yearq_S2070+1,ch4_spear[yearq_S2070]]
p2_S2070_ch4 = [len(yearstotal_extend)*12,ch4_spear[0]+(ch4_spear[yearq_S2070] - ch4_spear[yearq_S2020])]
length_S2070_ch4 = (len(yearstotal_extend)*12) - yearq_S2070
p3_S2070_ch4 = [yearq_S2070+120,ch4_spear[yearq_S2070+(5*12)]]
x_S2070_ch4, y_S2070_ch4= draw_curve(p1_S2070_ch4, p2_S2070_ch4, p3_S2070_ch4, length_S2070_ch4)
                             
### Hypothetical decrease 2080
yearq_S2080 = np.where(yearstotal == 2080)[0][0]*12
p1_S2080_ch4 = [yearq_S2080+1,ch4_spear[yearq_S2080]]
p2_S2080_ch4 = [len(yearstotal_extend)*12,ch4_spear[0]+(ch4_spear[yearq_S2080] - ch4_spear[yearq_S2020])]
length_S2080_ch4 = (len(yearstotal_extend)*12) - yearq_S2080
p3_S2080_ch4 = [yearq_S2080+120,ch4_spear[yearq_S2080+(2*12)]]
x_S2080_ch4, y_S2080_ch4= draw_curve(p1_S2080_ch4, p2_S2080_ch4, p3_S2080_ch4, length_S2080_ch4)
...
### Save figure
plt.savefig(directoryfigure+'TimeSeries_All-Scenarios_GHG_hypothetical_v1.png',dpi=600)
...
def concFiles_co2(data,startyr,spear,yearstotal_extend):
    ...
    np.savetxt(directoryoutput + 'v1_Steeper/co2_gblannualdata_ssp%sos_from_wfc' % startyr,
...
def concFiles_ch4(data,startyr,spear,yearstotal_extend):
    ...
    np.savetxt(directoryoutput + 'v1_Steeper/ch4_gblannualdata_ssp%sos_from_wfc' % startyr,
