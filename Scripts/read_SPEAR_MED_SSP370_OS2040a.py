"""
Function(s) reads in monthly data from SPEAR_MED_SSP370_OS2040a for different variables 
...
Usage
-----
    [1] read_SPEAR_MED_SSP370_OS2040a(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
"""

def read_SPEAR_MED_SSP370_OS2040a(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper):
    """
    Function reads monthly data from SPEAR_MED_SSP370_OS2040a
    ...
    Usage
    -----
    read_SPEAR_MED_SSP370_OS2040a(directory,scenario,vari,sliceperiod,sliceshape,
                                 slicenan,numOfEns,timeper)
    """
    print('\n>>>>>>>>>> STARTING read_SPEAR_MED_SSP370_OS2040a function!')
    ...
    print('Scenario for this simulation of SPEAR_MED_SSP370_OS2040a is ---> %s!' % 'SSP370_OS2040a')

    ###########################################################################
    ### Read in data
    lat,lon,membersvar1 = SC.read_SPEAR_MED_Scenario(directoryScenario,'SSP370',vari,'none',5,slicenan,30,'OS40a')
    ...
    for i,ensmember in enumerate(ens):
        ...
        print('Completed: read *SPEAR_MED %s Ensemble Member --%s--' % ('SSP370_OS2040a',ensmember))
    ...
    print('>>>>>>>>>> ENDING read_SPEAR_MED_SSP370_OS2040a function!')    
...
# import calc_Utilities as UT
# directory = '/work/Zachary.Labe/Data/SPEAR/SPEAR_MED_SSP370_OS2040a/monthly/'
# vari = 'T2M'
# sliceperiod = 'annual'
# sliceshape = 4
# slicenan = 'nan'
# numOfEns = 30
# timeper = 'all'
# lat,lon,var = read_SPEAR_MED_SSP370_OS2040a(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
