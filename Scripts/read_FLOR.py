"""
Function(s) reads in monthly data from FLOR large ensemble for different 
...
Usage
-----
    [1] read_FLOR(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
"""

def read_FLOR(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper):
    """
    Function reads monthly data from FLOR
    ...
    Usage
    -----
    read_FLOR(directory,vari,sliceperiod,sliceshape,
                             slicenan,numOfEns,timeper)
    """
    print('\n>>>>>>>>>> STARTING read_FLOR function!')
    ...
    for i,ensmember in enumerate(ens):
        filename1 = directory + 'FLOR/FLOR_LE/monthly/%s/%s_%02d_1921-2100.nc' % (vari,vari,
                                                          ensmember)
        ...
        print('Completed: read *FLOR* Ensemble Member --%s-- for %s' % (ensmember,vari))
    ...
    del membersvar
    print('Completed: read all FLOR Members!\n')
    ...
    print('>>>>>>>>>> ENDING read_FLOR function!')    
...
# numOfEns = 30
# timeper = 'all'
# lat,lon,var = read_FLOR(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
