"""
Calculate heat extremes regressed on the IPO index
...
### Save output
directorydata = '/work/Zachary.Labe/Data/ClimateIndices/IPO/'
if detrend == True:
    np.savez(directorydata + 'IPO_SST_SPEAR-MED_%s_2015-2100_detrend.npz' % monthlychoice,
                  spear_unfilter=ave_spear,years=years)
    np.savez(directorydata + 'IPO_SST_SPEAR-MED-SSP534OS_%s_2015-2100_detrend.npz' % monthlychoice,
                  spear_os_unfilter=ave_spear_os,years=years)
    np.savez(directorydata + 'IPO_SST_SPEAR-MED-SSP534OS-10ye_%s_2015-2100_detrend.npz' % monthlychoice,
                  spear_os10ye_unfilter=ave_spear_os10ye,years=years)
elif detrend == False:
    np.savez(directorydata + 'IPO_SST_SPEAR-MED_%s_2015-2100.npz' % monthlychoice,
                  spear_unfilter=ave_spear,years=years)
    np.savez(directorydata + 'IPO_SST_SPEAR-MED-SSP534OS_%s_2015-2100.npz' % monthlychoice,
                  spear_os_unfilter=ave_spear_os,years=years)
    np.savez(directorydata + 'IPO_SST_SPEAR-MED-SSP534OS-10ye_%s_2015-2100.npz' % monthlychoice,
                  spear_os10ye_unfilter=ave_spear_os10ye,years=years)
...
###############################################################################
###############################################################################
### Regress heatwave day anomalies onto IPO index
...
label = r'\textbf{Regression Coefficients [IPO; days]}'
...
plt.savefig(directoryfigure + 'Regression_IPO-HeatDays_TMAX_%s_2015-2100.png' % (monthlychoice),dpi=300)
