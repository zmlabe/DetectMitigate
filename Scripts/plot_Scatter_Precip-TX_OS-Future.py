"""
Examine relationship between precipitation and heatwaves with SSP585
...
plt.ylabel(r'\textbf{Precipitation Anomaly [mm/day; MAM]}',fontsize=11,color='dimgrey')
...
plt.tight_layout()
plt.savefig(directoryfigure + 'Scatter_PrecipMAM-Tx90_OS_ssp585.png',dpi=300)
