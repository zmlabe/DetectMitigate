"""
Calculate trend for OS with daily TMIN with global maps
...
if variq == 'TMIN':
    if varcount == 'count90':
        label = r'\textbf{Count of Tn90}' 
    elif varcount == 'count95':
        label = r'\textbf{Count of Tn95}' 
elif variq == 'T2M':
    if varcount == 'count90':
        label = r'\textbf{Count of T2M-Tn90}' 
    elif varcount == 'count95':
        label = r'\textbf{Count of T2M-Tn95}'
