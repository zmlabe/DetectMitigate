...
for i in range(len(periods_15)*3):
    ...
    # ### Only show CONUS
    # var_mask,data_obsnan = dSS.mask_CONUS(var,data_obsnan,'MEDS',lat_bounds,lon_bounds)
...
plt.savefig(directoryfigure + 'PercentEnsMembers_TMAXabs_JJAmean.png',dpi=300)
