"""
Function(s) reads in monthly data from SPEAR_MED_NATURAL for different variables 
...
Usage
-----
    [1] read_SPEAR_MED_NATURAL(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
"""

def read_SPEAR_MED_NATURAL(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper):
    """
    Function reads monthly data from SPEAR_MED_NATURAL
    ...
    Usage
    -----
    read_SPEAR_MED_NATURAL(directory,vari,sliceperiod,sliceshape,
                             slicenan,numOfEns,timeper)
    """
    print('\n>>>>>>>>>> STARTING read_SPEAR_MED_NATURAL function!')
    ...
    for i,ensmember in enumerate(ens):
        filename = directory + '%s/%s_%02d_1921-2100.nc' % (vari,vari,
                                                          ensmember)
        ...
        print('Completed: read *SPEAR_MED_NATURAL natural-all* Ensemble Member --%s--' % ensmember)
    ...
    print('Completed: read all SPEAR_MED_NATURAL Members!\n')
    ...
    print('>>>>>>>>>> ENDING read_SPEAR_MED_NATURAL function!')    
...
# import calc_Utilities as UT
# import sys
# directory = '/work/Zachary.Labe/Data/SPEAR/SPEAR_MED_NATURAL/monthly/'
# vari = 'T2M'
# sliceperiod = 'annual'
# sliceshape = 4
# slicenan = 'nan'
# numOfEns = 30
# timeper = 'satellite'
# lat,lon,var = read_SPEAR_MED_NATURAL(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
