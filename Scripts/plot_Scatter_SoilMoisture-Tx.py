"""
Examine relationship between soil moisture and heatwaves
...
slope_end_os,intercept_end_os,r_end_os,p_end_os,se_end_os = sts.linregress(endMean_os.ravel(),endMean_os_vari.ravel()/1000.)
...
plt.tight_layout()
plt.savefig(directoryfigure + 'Scatter_SoilMoisture-Tx90_OS.png',dpi=300)
