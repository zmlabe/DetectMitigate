"""
Calculate timeseries of Global means of q (Wet)
...
# directorydatah = '/work/Zachary.Labe/Research/DetectMitigate/DataExtremes/'
# nameSSP245 = 'MoistStats/MoistStats' + '_JJA_' + reg_name + '_' + variq + '_' + 'SPEAR_MED_SSP245' + '.nc'
...
plt.ylabel(r'\textbf{Frequency of qx90-Wet over Globe [Percent]}',fontsize=7,color='k')

plt.tight_layout()
plt.savefig(directoryfigure + 'TimeSeries_qx90_%s_%s_LM42.png' % (seasons[0],reg_name),dpi=300)
...
plt.ylabel(r'\textbf{Frequency of qx95-Wet over Globe [Percent]}',fontsize=7,color='k')

plt.tight_layout()
plt.savefig(directoryfigure + 'TimeSeries_qx95-Wet_%s_%s_LM42.png' % (seasons[0],reg_name),dpi=300)
