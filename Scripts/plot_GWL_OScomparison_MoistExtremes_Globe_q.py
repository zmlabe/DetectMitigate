"""
Calculate trend for OS with daily q with global maps
...
plt.savefig(directoryfigure + 'GWL-%s_MoistExtremes_Globe_%s_%s_%s-%s.png' % (selectGWLn,variq,seasons[0],varcount,variq),dpi=300)
