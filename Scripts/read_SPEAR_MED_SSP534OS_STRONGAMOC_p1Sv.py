"""
Function(s) reads in monthly data from SPEAR_MED_SSP534OS_STRONGAMOC_p1Svs for different variables 
...
Usage
-----
    [1] read_SPEAR_MED_SSP534OS_STRONGAMOC_p1Sv(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
"""

def read_SPEAR_MED_SSP534OS_STRONGAMOC_p1Sv(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper):
    """
    Function reads monthly data from SPEAR_MED_SSP534OS_STRONGAMOC_p1Sv
    ...
    Usage
    -----
    read_SPEAR_MED_SSP534OS_STRONGAMOC_p1Sv(directory,scenario,vari,sliceperiod,sliceshape,
                                 slicenan,numOfEns,timeper)
    """
    print('\n>>>>>>>>>> STARTING read_SPEAR_MED_SSP534OS_STRONGAMOC_p1Sv function!')
    ...
    timesat1 = np.arange(1921,2040+1,1)
    timesat2 = np.arange(2041,2100+1,1)
 
    ###########################################################################
    ### Climate change emissions scenario
    directoryScenario = '/work/Zachary.Labe/Data/SPEAR/SPEAR_MED/monthly/'

    print('Scenario for this simulation of SPEAR_MED_SSP534OS_STRONGAMOC_p1Sv is ---> %s!' % 'STRONGAMOC')

    ###########################################################################
    ### Read in data
    lat,lon,membersvar1 = SC.read_SPEAR_MED_Scenario(directoryScenario,'SSP534OS',vari,'none',5,slicenan,9,'STRONGAMOC')
    
    membersvar2 = []
    for i,ensmember in enumerate(ens):
        filename2 = directory + '%s/%s_%02d_2041-2100.nc' % (vari,vari,
                                                          ensmember)
        ...
        print('Completed: read *SPEAR_MED %s Ensemble Member --%s--' % ('SPEAR_MED_SSP534OS_STRONGAMOC_p1Sv',ensmember))
    ...
    print('>>>>>>>>>> ENDING read_SPEAR_MED_SSP534OS_STRONGAMOC_p1Sv function!')    
...
# import calc_Utilities as UT
# directory = '/work/Zachary.Labe/Data/SPEAR/SPEAR_MED_SSP534OS_STRONGAMOC_p1Sv/monthly/'
# vari = 'T2M'
# sliceperiod = 'annual'
# sliceshape = 4
# slicenan = 'nan'
# numOfEns = 9
# timeper = 'all'
# lat,lon,var = read_SPEAR_MED_SSP534OS_STRONGAMOC_p1Sv(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
