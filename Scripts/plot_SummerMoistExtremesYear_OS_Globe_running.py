"""
Calculate a map of the Wettest Q year for the ensemble mean in the overshoot runs
for the count of moist extremes but with running mean
...
directorydatah = '/work/Zachary.Labe/Research/DetectMitigate/DataExtremes/'
name_os = 'MoistStats/MoistStats' + '_JJA_' + reg_name + '_' + variq + '_' + 'SPEAR_MED_SSP534OS' + '.nc'
...
directorydatah = '/work/Zachary.Labe/Research/DetectMitigate/DataExtremes/'
name_os10ye = 'MoistStats/MoistStats' + '_JJA_' + reg_name + '_' + variq + '_' + 'SPEAR_MED_SSP534OS_10ye' + '.nc'
...
### Locate max of Wettest Q year at each grid point
...
cmap = cmr.dusk
label = r'\textbf{Wettest Q %s [Ensemble Mean]}' % seasons[0]
...
plt.savefig(directoryfigure + 'SummerMoistExtremesYear_OS-T2M_%s_%s_running-%syr_%s.png' % (variq,seasons[0],rolling_years,varcount),dpi=300)

###############################################################################
###############################################################################
###############################################################################
### Plot difference in Wettest Q year
limit = np.arange(-50,51,5)
barlim = np.round(np.arange(-50,51,10),2)
cmap = cmocean.cm.balance
label = r'\textbf{Difference in Wettest Q Year [Ensemble Mean]}'
...
plt.savefig(directoryfigure + 'SummerMoistExtremesYear-Difference_OS-T2M_%s_%s_running-%syr_%s.png' % (variq,seasons[0],rolling_years,varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerMoistExtremesYear-Benefit_OS-T2M_%s_%s_running-%syr_%s.png' % (variq,seasons[0],rolling_years,varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerMoistExtremesYear-BenefitMask_OS-%s_%s_running-%syr_%s.png' % (variq,seasons[0],rolling_years,varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerMoistExtremesYear-BenefitMask_OS-%s_%s_running-%syr_%s_land.png' % (variq,seasons[0],rolling_years,varcount),dpi=300)
