"""
Function(s) reads in monthly data from SPEAR_MED_Historical for different variables 
using # of ensemble members for only the historical era
...
Usage
-----
    [1] read_SPEAR_MED_Historical(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
"""

def read_SPEAR_MED_Historical(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper):
    """
    Function reads monthly data from SPEAR_MED_Historical
    ...
    Usage
    -----
    read_SPEAR_MED_Historical(directory,vari,sliceperiod,sliceshape,
                             slicenan,numOfEns,timeper)
    """
    print('\n>>>>>>>>>> STARTING read_SPEAR_MED_Historical function!')
    ...
    for i,ensmember in enumerate(ens):
        ...
        print('Completed: read *SPEAR_MED_Historical historical* Ensemble Member --%s--' % ensmember)
    ...
    for i,ensmember in enumerate(ens):
        ...
        print('Completed: read *SPEAR_MED_Historical SSP585* Ensemble Member --%s--' % ensmember)
    ...
    del membersvar1
    del membersvar2
    print('Completed: read all SPEAR_MED_Historical Members!\n')
    ...
    print('>>>>>>>>>> ENDING read_SPEAR_MED_Historical function!')    
...
# slicenan = 'nan'
# numOfEns = 30
# timeper = 'historicalforcing'
# lat,lon,var = read_SPEAR_MED_Historical(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
