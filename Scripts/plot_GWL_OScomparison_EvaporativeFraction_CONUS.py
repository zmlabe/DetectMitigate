"""
Calculate trend for OS for the Evaporative Fraction but just for the CONUS

evaporative fraction (Latent/(Latent+Sensible))
...
### Colorbar limits
barlim = np.arange(-0.2,0.21,0.1)
limit = np.arange(-0.2,0.21,0.01)
barlim2 = np.arange(-0.2,0.21,0.1)
limit2 = np.arange(-0.2,0.21,0.01)
label = r'\textbf{Evaporative Fraction [unitless]}' 
...
plt.savefig(directoryfigure + 'GWL-%s_%s_%s_CONUS.png' % (selectGWLn,'EvaporativeFraction',seasons[0]),dpi=300)
