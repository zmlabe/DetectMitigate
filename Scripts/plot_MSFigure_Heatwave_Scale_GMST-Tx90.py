...
plt.plot(dec_gmst_585,dec_heat_585,linestyle='-',linewidth=2.5,color='maroon',zorder=3,label=r'\textbf{SSP5-8.5}',marker='o',markersize=5)  

plt.plot(dec_gmst_245,dec_heat_245,linestyle='--',dashes=(1,0.3),linewidth=1,color='darkorange',zorder=3,label=r'\textbf{SSP2-4.5}',marker='o',markersize=5) 
plt.plot(dec_gmst_245[-1],dec_heat_245[-1],linestyle='-',linewidth=1,color='k',zorder=3,marker='o',markersize=7)   

plt.plot(dec_gmst_os,dec_heat_os,linestyle='-',linewidth=2.5,color='darkslategrey',zorder=3,label=r'\textbf{SSP5-3.4OS}',marker='o',markersize=5)  
plt.plot(dec_gmst_os[-1],dec_heat_os[-1],linestyle='-',linewidth=2,color='k',zorder=3,marker='o',markersize=7)   

plt.plot(dec_gmst_os10ye,dec_heat_os10ye,linestyle='-',linewidth=1,color='teal',zorder=3,label=r'\textbf{SSP5-3.4OS_10ye}',marker='o',markersize=5) 
...
leg = plt.legend(shadow=False,fontsize=7,loc='upper center',
      bbox_to_anchor=(0.5,1.01),fancybox=True,ncol=2,frameon=False,
...
plt.ylabel(r'\textbf{Frequency of %s over US [\%%]}' % (extremen),fontsize=7,color='k')

plt.tight_layout()
plt.savefig(directoryfigure + 'MSFigure_Heatwave_TimeSeries_Scale_GMST-%s_%s_%s_byDecade_zoom.png' % (extremen,seasons[0],reg_name),dpi=300)
