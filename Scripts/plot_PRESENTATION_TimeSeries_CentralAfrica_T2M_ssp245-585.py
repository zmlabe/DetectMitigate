"""
Plots timeseries of temperature over central Africa using SSP585 and
SSP245
...
plt.tight_layout()
plt.savefig(directoryfigure + 'PRESENTATION_CentralAfrica_%s_EmissionScenarios_%s_ssp245_585.png' % (variq,monthlychoice),dpi=300)
