"""
Explore moisture extremes in the OS runs
...
def calc_MoistExtremes(datamask,model,lat,lon,baselineanom):
    ...
    ### Count of Moist extremes for 95th percentile
    ...
    ### Count of Moist extremes for 99th percentile
...
##############################################################################
##############################################################################
def netcdfMoist(lats,lons,count90v,count95v,count99v,freq90v,freq95v,freq99v,directory,model,reg_name,vari):
    print('\n>>> Using netcdfMoist function!')
    
    from netCDF4 import Dataset
    import numpy as np
    
    name = 'MoistStats/MoistStats' + '_JJA_' + reg_name + '_' + vari + '_' + model + '.nc'
    filename = directory + name
    ncfile = Dataset(filename,'w',format='NETCDF4')
    ncfile.description = '90th, 95th, and 99th percentiles for JJA Moist' 
...
# netcdfMoist(lat,lon,count90_osSSP245,count95_osSSP245,count99_osSSP245,freq90_osSSP245,freq95_osSSP245,freq99_osSSP245,directorydata,'SPEAR_MED_SSP245',reg_name,vari)
# netcdfMoist(lat,lon,count90_LM42p2_test,count95_LM42p2_test,count99_LM42p2_test,freq90_LM42p2_test,freq95_LM42p2_test,freq99_LM42p2_test,directorydata,'SPEAR_MED_LM42p2_test',reg_name,vari)
