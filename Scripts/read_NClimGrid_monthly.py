"""
Function reads in monthly data from NClimGrid
...
Usage
-----
    [1] read_NClimGrid_monthly(variq,directory,sliceperiod,sliceyear,
                                   sliceshape,slicenan)
"""

def read_NClimGrid_monthly(variq,directory,sliceperiod,sliceyear,sliceshape,slicenan):
    """
    Function reads monthly data from NClimGrid on its original grid grid
    ...
    Usage
    -----
    lat,lon,lev,var = read_NClimGrid_monthly(variq,directory,sliceperiod,sliceyear,
                                                 sliceshape,slicenan)
    """
    print('\n>>>>>>>>>> STARTING read_NClimGrid_monthly function!')
    ...
    filename = 'NClimGrid/%s_1895-2021.nc' % variq
    ...
    print('>>>>>>>>>> ENDING read_NClimGrid_monthly function for -- %s!' % variq)
...
# sliceshape = 3
# slicenan = 'nan'
# lat,lon,var = read_NClimGrid_monthly(variq,directory,sliceperiod,
