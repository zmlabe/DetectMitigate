"""
Examine relationship between WA and heatwaves
...
plt.ylabel(r'\textbf{P-E Anomaly [mm/day]}',fontsize=11,color='dimgrey')
...
plt.tight_layout()
plt.savefig(directoryfigure + 'Scatter_WA-Tx90_OS.png',dpi=300)
