"""
Function(s) reads in monthly data from SPEAR_LOW for different variables 
...
Usage
-----
    [1] read_SPEAR_LOW(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
"""

def read_SPEAR_LOW(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper):
    """
    Function reads monthly data from SPEAR_LOW
    ...
    Usage
    -----
    read_SPEAR_LOW(directory,vari,sliceperiod,sliceshape,
                             slicenan,numOfEns,timeper)
    """
    print('\n>>>>>>>>>> STARTING read_SPEAR_LOW function!')
    ...
    for i,ensmember in enumerate(ens):
        filename1 = directory + '%s/%s_%02d_1851-2010.nc' % (vari,vari,
                                                          ensmember)
        ...
        print('Completed: read *SPEAR_LOW historical* Ensemble Member --%s--' % ensmember)
    ...
    for i,ensmember in enumerate(ens):
        ...
        print('Completed: read *SPEAR_LOW SSP585* Ensemble Member --%s--' % ensmember)
    ...
    del membersvar1
    del membersvar2
    print('Completed: read all SPEAR_LOW Members!\n')
    ...
    print('>>>>>>>>>> ENDING read_SPEAR_LOW function!')    
...
# import calc_Utilities as UT
# directory = '/work/Zachary.Labe/Data/SPEAR/SPEAR_LOW/monthly/'
# vari = 'T2M'
# sliceperiod = 'annual'
# sliceshape = 4
# slicenan = 'nan'
# numOfEns = 30
# timeper = 'all'
# lat,lon,var = read_SPEAR_LOW(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
