...
plt.text(-17,71,r'\textbf{Ridge Regularization [L$_{2}$] -- SSP245 or SSP585 for %s}' % variqname,fontsize=8,color='k',
         ha='left',va='center')  
plt.savefig(directoryfigure + 'MSFigure_ANN_LoopHyperparameters_ssp_245_585_%s.png' % (variq),dpi=600)
