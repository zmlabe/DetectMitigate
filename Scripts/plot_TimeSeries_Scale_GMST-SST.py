"""
Calculate timeseries of Global means of T2M and scaled for SST
...
plt.xlabel(r'\textbf{GMST relative to 1921-1950 [$^{\circ}$C]}',fontsize=7,color='k')
plt.ylabel(r'\textbf{SH GMSST [$^{\circ}$C]}',fontsize=7,color='k')

plt.tight_layout()
plt.savefig(directoryfigure + 'TimeSeries_Scale_GMST-GMSST_%s_%s_byDecade_SH.png' % (seasons[0],reg_name),dpi=300)
