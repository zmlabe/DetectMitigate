...
# plt.title(r'\textbf{ANN CONFIDENCE OF SSP534OS -- %s}' % (variq),color='k',fontsize=10)

plt.tight_layout()
plt.subplots_adjust(bottom=0.15)
plt.savefig(directoryfigure + 'POSTER_%s_Confidence.png' % (savename),dpi=300)
...
norm = cccc.BoundaryNorm(np.arange(1,31+1,1),csm.N)
...
plt.savefig(directoryfigure + 'POSTER_%s_NumberOfEnsChoices.png' % (savename),dpi=300)
