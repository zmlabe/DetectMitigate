"""
Calculate timeseries of US means of TMIN and compare to TMAX for SSP245 too
...
### Read in SPEAR_MED_SSP245 - TMAX
directorydatah = '/work/Zachary.Labe/Research/DetectMitigate/DataExtremes/'
name = 'HeatStats/HeatStats' + '_JJA_' + reg_name + '_' + variq + '_' + 'SPEAR_MED_SSP245' + '.nc'
filename_SSP245 = directorydatah + name
data_SSP245 = Dataset(filename_SSP245)
latus_SSP245 = data_SSP245.variables['lat'][:]
lonus_SSP245 = data_SSP245.variables['lon'][:]
freq90_SSP245 = data_SSP245.variables['freq90'][:]
data_SSP245.close()
...
avg_freq90_SSP245 = UT.calc_weightedAve(freq90_SSP245,lat2us)
...
ave_avg_SSP245 = np.nanmean(avg_freq90_SSP245,axis=0)
...
latus_SSP245 = data_SSP245.variables['lat'][:]
lonus_SSP245 = data_SSP245.variables['lon'][:]
freq90_SSP245_tmin = data_SSP245.variables['freq90'][:]
data_SSP245.close()
...
avg_freq90_SSP245_tmin = UT.calc_weightedAve(freq90_SSP245_tmin,lat2us)
...
ave_avg_SSP245_tmin = np.nanmean(avg_freq90_SSP245_tmin,axis=0)
...
plt.plot(years,ave_avg_SSP245*100.,linestyle='-',linewidth=1,color='darkorange',zorder=3,label=r'\textbf{SPEAR_MED_SSP245}')    
...
plt.plot(years,ave_avg_SSP245_tmin*100.,linestyle='--',dashes=(1,0.3),linewidth=1,color='darkorange',zorder=3)    
