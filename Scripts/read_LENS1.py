"""
Function(s) reads in monthly data from LENS1 large ensemble for different 
...
Usage
-----
    [1] read_LENS1(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
"""

def read_LENS1(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper):
    """
    Function reads monthly data from LENS1
    ...
    Usage
    -----
    read_LENS1(directory,vari,sliceperiod,sliceshape,
                             slicenan,numOfEns,timeper)
    """
    print('\n>>>>>>>>>> STARTING read_LENS1 function!')
    ...
    for i,ensmember in enumerate(ens):
        filename1 = directory + 'LENS1/monthly/%s/%s_%03d_1920-2100.nc' % (vari,vari,
                                                          ensmember)
        ...
        print('Completed: read *LENS1* Ensemble Member --%s-- for %s' % (ensmember,vari))
    ...
    del membersvar
    print('Completed: read all LENS1 Members!\n')
    ...
    print('>>>>>>>>>> ENDING read_LENS1 function!')    
...
# numOfEns = 40
# timeper = 'all'
# lat,lon,var = read_LENS1(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
