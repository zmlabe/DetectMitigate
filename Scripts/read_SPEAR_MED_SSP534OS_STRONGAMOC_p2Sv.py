"""
Function(s) reads in monthly data from SPEAR_MED_SSP534OS_STRONGAMOC_p2Svs for different variables 
...
Usage
-----
    [1] read_SPEAR_MED_SSP534OS_STRONGAMOC_p2Sv(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
"""

def read_SPEAR_MED_SSP534OS_STRONGAMOC_p2Sv(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper):
    """
    Function reads monthly data from SPEAR_MED_SSP534OS_STRONGAMOC_p2Sv
    ...
    Usage
    -----
    read_SPEAR_MED_SSP534OS_STRONGAMOC_p2Sv(directory,scenario,vari,sliceperiod,sliceshape,
                                 slicenan,numOfEns,timeper)
    """
    print('\n>>>>>>>>>> STARTING read_SPEAR_MED_SSP534OS_STRONGAMOC_p2Sv function!')
    ...
    print('Scenario for this simulation of SPEAR_MED_SSP534OS_STRONGAMOC_p2Sv is ---> %s!' % 'STRONGAMOC')
    ...
    for i,ensmember in enumerate(ens):
        ...
        print('Completed: read *SPEAR_MED %s Ensemble Member --%s--' % ('SPEAR_MED_SSP534OS_STRONGAMOC_p2Sv',ensmember))
    ...
    print('>>>>>>>>>> ENDING read_SPEAR_MED_SSP534OS_STRONGAMOC_p2Sv function!')    
...
# import calc_Utilities as UT
# directory = '/work/Zachary.Labe/Data/SPEAR/SPEAR_MED_SSP534OS_STRONGAMOC_p2Sv/monthly/'
# vari = 'T2M'
# sliceperiod = 'annual'
# sliceshape = 4
# slicenan = 'nan'
# numOfEns = 9
# timeper = 'all'
# lat,lon,var = read_SPEAR_MED_SSP534OS_STRONGAMOC_p2Sv(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
