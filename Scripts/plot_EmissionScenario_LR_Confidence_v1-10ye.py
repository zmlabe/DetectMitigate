...
plt.title(r'\textbf{LR CONFIDENCE OF SSP534OS_10ye -- %s - %s}' % (variq,reg_name),color='dimgrey',fontsize=10)

plt.tight_layout()
plt.subplots_adjust(bottom=0.15)
plt.savefig(directoryfigure + '%s_Confidence_10ye.png' % (savename),dpi=300)
...
plt.yticks(np.arange(0.5,5.5,1),scenarioall,ha='right',va='center',color='k',size=6)
yax = ax.get_yaxis()
...
cbar.set_label(r'\textbf{NUMBER OF ENSEMBLE MEMBERS [_10ye]}',color='k',labelpad=7,fontsize=18)
...
plt.savefig(directoryfigure + '%s_NumberOfEnsChoices_10ye.png' % (savename),dpi=300)
