...
hiddenalltry = [[20],[100],[5,5],[30,30],[100,100],[5,5,5],[20,20,20],[100,100,100],[5,5,5,5],[30,30,30,30],[100,100,100,100]]
...
for hh in range(len(hiddenalltry)):
    ...
    ### Save seeds
    np.savez(directoryoutputo + 'Metadata_LoopResultsfor_ANNv3_EmissionScenario_LoopHyper_hidden-%s.npz' % hiddenallstr,
