...
plt.plot(years,landMean_spear-oceanMean_spear,color='maroon',linewidth=4,linestyle='-',label=r'\textbf{SSP5-8.5}')
plt.plot(years,landMean_spear_os-oceanMean_spear_os,color='darkslategrey',linewidth=4,label=r'\textbf{SSP5-3.4OS}')
plt.plot(years[-len(years_os10ye):],landMean_spear_os10ye[-len(years_os10ye):]-oceanMean_spear_os10ye[-len(years_os10ye):],color = 'teal',linewidth = 2,linestyle='--',dashes=(1,0.3),label=r'\textbf{SSP5-3.4OS_10ye}')
...
plt.tight_layout()
plt.savefig(directoryfigure + 'MSFigure_TimeSeries_difference_LandOcean_JJA.png',dpi=300)
...
plt.tight_layout()
plt.savefig(directoryfigure + 'MSFigure_TimeSeries_ratio_LandOcean_JJA.png',dpi=300)
