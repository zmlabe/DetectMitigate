"""
Function reads in monthly data from ERA5 for 1x1 data
...
Usage
-----
    [1] read_ERA5_monthly1x1(variq,directory,sliceperiod,sliceyear,
                  sliceshape,addclimo,slicenan,level)
"""

def read_ERA5_monthly1x1(variq,directory,sliceperiod,sliceyear,sliceshape,addclimo,slicenan,level):
    """
    ...
    Usage
    -----
    lat,lon,lev,var = read_ERA5_monthly1x1(variq,directory,sliceperiod,sliceyear,
                            sliceshape,addclimo,slicenan,level)
    """
    ...
    print('>>>>>>>>>> ENDING read_ERA5_monthly1x1 function for -- %s!' % variq)
...
# addclimo = True
# level = 'surface'
# lat,lon,lev,var = read_ERA5_monthly1x1(variq,directory,sliceperiod,
