"""
Function(s) reads in monthly data from LENS2 for different variables 
using 100 ensemble members for all time periods
...
Usage
-----
    [1] read_LENS2(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
"""

def read_LENS2(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper):
    """
    Function reads monthly data from LENS2
    ...
    Usage
    -----
    read_LENS2(directory,vari,sliceperiod,sliceshape,
                             slicenan,numOfEns,timeper)
    """
    print('\n>>>>>>>>>> STARTING read_LENS2 function!')
    ...
    for i,ensmember in enumerate(ens):
        ...
        print('Completed: read *LENS2 historical* Ensemble Member --%s-- for %s' % (ensmember,vari))
    ...
    del membersvar
    print('Completed: read all LENS2 Members!\n')
    ...
    print('>>>>>>>>>> ENDING read_LENS2 function!')    
...
# import calc_Utilities as UT
# directory = '/work/Zachary.Labe/Data/LENS2/monthly/'
# vari = 'T2M'
# sliceperiod = 'annual'
# sliceshape = 4
# slicenan = 'nan'
# numOfEns = 100
# timeper = 'all'
# lat,lon,var = read_LENS2(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
