"""
Fourth version of classification problem for emission scenario

Author     : Zachary M. Labe
Date       : 1 September 2023
Version    : 1 binary for ssp245 or ssp585, 2 - added capability for all XAI of OS ensemble members, 3 does not exist to match other ANN, 4 - selected architecture based on hyperparameter sweep
"""
...
def loadmodel(Xtrain,Xval,Ytrain,Yval,hidden,random_network_seed,n_epochs,batch_size,lr_here,ridgePenalty,actFun,class_weight,input_shape,output_shape):
    ...
    plt.xlabel('epoch')
    plt.legend()
    plt.savefig(directoryfigure + 'loss_ann_v4_binary245585.png',dpi=300)
    ...
    plt.xlabel('epoch')
    plt.legend()
    plt.savefig(directoryfigure + 'accuracy_ann_v4_binary245585.png',dpi=300)
