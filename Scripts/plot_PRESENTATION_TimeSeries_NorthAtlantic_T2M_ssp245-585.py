...
colors = ['r',cmocean.cm.balance(0.65)]
...
plt.title(r'\textbf{NORTH ATLANTIC %s' % variq,fontsize=15,color='w')

plt.tight_layout()
plt.savefig(directoryfigure + 'PRESENTATION_NorthAtlantic_%s_EmissionScenarios_%s_ssp245_585.png' % (variq,monthlychoice),dpi=300)
...
plt.ylabel(r'\textbf{2-m Temperature [$^{\circ}$C]}',
            fontsize=10,color='darkgrey')
plt.title(r'\textbf{NORTHERN NORTH ATLANTIC %s' % variq,fontsize=15,color='w')

plt.tight_layout()
plt.savefig(directoryfigure + 'PRESENTATION_NorthNorthAtlantic_%s_EmissionScenarios_%s_ssp245_585.png' % (variq,monthlychoice),dpi=300)
