"""
Evaluate differences with SPEAR and SPEAR LM4.2 for evaporative fraction
...
###############################################################################
        ...
        ### Calculate differences and Evaporative fraction
        diff = (lai_mlr/(lai_mlrsh+lai_mlr)) - (lai_ms/(lai_ms+lai_mssh))
        ...
        label = r'\textbf{Evaporative Fraction Difference [unitless]}' 
        ...
        plt.title(r'\textbf{(a) LM4.2 -- LM4; %s; 1921-1950 - %s}' % ('EvaporativeFraction',monthlychoice),fontsize=11,color='dimgrey')
        ...
        plt.title(r'\textbf{(b) LM4.2 -- LM4; %s; 2041-2070 - %s}' % ('EvaporativeFraction',monthlychoice),fontsize=11,color='dimgrey')
        ...
        plt.savefig(directoryfigure + 'Comparison%s_LM42_US_%s.png' % ('EvaporativeFraction',monthlychoice),dpi=300)
        ...
        plt.savefig(directoryfigure + 'Comparison%s_LM42_Globe_%s.png' % ('EvaporativeFraction',monthlychoice),dpi=300)
