"""
Calculate trend for OS with daily q with global maps (dry)
...
plt.savefig(directoryfigure + 'GWL-%s_DryExtremes_Globe_%s_%s_%s-%s.png' % (selectGWLn,variq,seasons[0],varcount,variq),dpi=300)
