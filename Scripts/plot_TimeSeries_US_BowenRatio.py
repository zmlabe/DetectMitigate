"""
Calculate timeseries of CONUS mean of Bowen Ratio
...
### Limit to +-5 for scaling
spear_hm[np.where(spear_hm >= 100)] = 100
spear_hm[np.where(spear_hm <= -100)] = -100
spear_am[np.where(spear_am >= 100)] = 100
spear_am[np.where(spear_am <= -100)] = -100
spear_aosm[np.where(spear_aosm >= 100)] = 100
spear_aosm[np.where(spear_aosm <= -100)] = -100
spear_aosm_10ye[np.where(spear_aosm_10ye >= 100)] = 100
spear_aosm_10ye[np.where(spear_aosm_10ye <= -100)] = -100
...
plt.yticks(np.round(np.arange(-10,10.1,0.5),2),np.round(np.arange(-10,10.1,0.5),2))
plt.xlim([1921,2100])
plt.ylim([-1.5,4])
