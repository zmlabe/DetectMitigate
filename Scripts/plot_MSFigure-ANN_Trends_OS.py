...
scenarioallnames = ['SPEAR_MED_SSP534OS','SPEAR_MED_SSP534OS_10ye','SPEAR_MED_SSP534OS_10ye','SPEAR_MED_SSP534OS']
###############################################################################
###############################################################################
land_only = False
ocean_only = False
...
trend_os = UT.linearTrend(data[0],years,'surface',2071,2100)*10.
trend_os10ye = UT.linearTrend(data[1],years,'surface',2071,2100)*10.
...
plt.savefig(directoryfigure + 'MSFigure_ANN_Trends_OS.png',dpi=600)
