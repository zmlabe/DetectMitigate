"""
Calculate timeseries of US means of q (Wet)
...
plt.ylabel(r'\textbf{Frequency of qx90-Wet over CONUS [Percent]}',fontsize=7,color='k')
...
plt.ylabel(r'\textbf{Frequency of qx95-Wet over CONUS [Percent]}',fontsize=7,color='k')
