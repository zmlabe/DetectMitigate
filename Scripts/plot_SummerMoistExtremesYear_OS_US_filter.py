...
for the count of summer temperature extremes but with running mean for only
the USA
...
reg_name = 'US'
varcount = 'count90'
B,A = sig.butter(6,0.15,output='ba')
###############################################################################
###############################################################################
###############################################################################
...
spear_osm_mean = np.asarray(np.append(spearslice,spear_osm_meann,axis=0))
spear_osm_10ye_mean = np.asarray(np.append(spearslice,spear_osm_10ye_meann,axis=0))
...
for i in range(lats.shape[0]):
    for j in range(lons.shape[0]):
        ...
        gridpoint_os = sig.filtfilt(B,A,gridpoint_osr)
        gridpoint_os_10ye = sig.filtfilt(B,A,gridpoint_osr_10ye)
        ...
        if (np.isfinite(gridpoint_os).any()) & (np.isfinite(gridpoint_os_10ye).any()):
...
plt.savefig(directoryfigure + 'SummerMoistExtremesYear_OS_%s_%s_%s_US.png' % (variq,seasons[0],varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerMoistExtremesYear-Difference_OS_%s_%s_%s_US.png' % (variq,seasons[0],varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerMoistExtremesYear-Benefit_OS_%s_%s_%s_US.png' % (variq,seasons[0],varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerMoistExtremesYear-BenefitMask_OS-%s_%s_%s_US.png' % (variq,seasons[0],varcount),dpi=300)
