"""
Evaluate differences with SPEAR and SPEAR LM4.2 for LHFLX
...
for v in range(len(variablesall)):
    for m in range(len(monthlychoiceall)):
        ...
        label = r'\textbf{LHFLX Difference [W/m2]}' 
        ...
        plt.title(r'\textbf{(a) LM4.2 -- LM4; %s; 1921-1950 - %s}' % ('LHFLX',monthlychoice),fontsize=11,color='dimgrey')
        ...
        plt.title(r'\textbf{(b) LM4.2 -- LM4; %s; 2041-2070 - %s}' % ('LHFLX',monthlychoice),fontsize=11,color='dimgrey')
        ...
        plt.savefig(directoryfigure + 'Comparison%s_LM42_US_%s.png' % ('LHFLX',monthlychoice),dpi=300)
        ...
        plt.savefig(directoryfigure + 'Comparison%s_LM42_Globe_%s.png' % ('LHFLX',monthlychoice),dpi=300)
