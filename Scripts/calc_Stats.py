...
def read_InferenceLargeEnsemble(variq,dataset,dataset_obs,monthlychoice,scenario,resolution,lat_bounds,lon_bounds,land_only,ocean_only,Xmean,Xstd,ensembleMember):
    import calc_dataFunctions as df
    import numpy as np
    import sys
    ...
    ### Standardize testing ensemble member
    XinferenceMemberS = (XinferenceMember-Xmean)/Xstd
