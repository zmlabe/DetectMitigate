"""
Function(s) reads in monthly data from SPEAR_HIGH for different variables 
...
Usage
-----
    [1] read_SPEAR_HIGH(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
"""

def read_SPEAR_HIGH(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper):
    """
    Function reads monthly data from SPEAR_HIGH
    ...
    Usage
    -----
    read_SPEAR_HIGH(directory,vari,sliceperiod,sliceshape,
                             slicenan,numOfEns,timeper)
    """
    print('\n>>>>>>>>>> STARTING read_SPEAR_HIGH function!')
    ...
    for i,ensmember in enumerate(ens):
        filename1 = directory + 'SPEAR/SPEAR_HIGH/monthly/%s/%s_%02d_1921-2010.nc' % (vari,vari,
                                                                                      ensmember)
        ...
        print('Completed: read *SPEAR_HIGH historical* Ensemble Member --%s--' % ensmember)
        membersvar1.append(var1)
        del var1

    membersvar2 = []
    for i,ensmember in enumerate(ens):
        filename2 = directory + 'SPEAR/SPEAR_HIGH/monthly/%s/%s_%02d_2011-2100.nc' % (vari,vari,
                                                          ensmember)
        ...
        print('Completed: read *SPEAR_HIGH SSP585* Ensemble Member --%s--' % ensmember)
    ...
    del membersvar1
    del membersvar2
    print('Completed: read all SPEAR_HIGH Members!\n')
    ...
    print('>>>>>>>>>> ENDING read_SPEAR_HIGH function!')    
...
# numOfEns = 10
# timeper = 'all'
# lat,lon,var = read_SPEAR_HIGH(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
