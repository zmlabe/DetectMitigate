...
for va in range(len(variablesall)):
    ...
    if any([variq == 'T2M', variq == 'SNOWRATE', variq == 'SNOW']):
        cmap = cmr.fusion_r
    ...
    for r in range(lenOfPicks):
        ...
        ax1.annotate(r'\textbf{%s [%s]}' % (scenarioall[r],count_os_sum[r]),xy=(0,0),xytext=(0.5,1.10),
    ...
    plt.savefig(directoryfigure + 'LRPComposites_%s_OS_ensemblemean.png' % (savename),dpi=300)
    ...
    if any([variq == 'T2M', variq == 'SNOWRATE', variq == 'SNOW']):
        ...
        cmap = cmr.waterlily
    label = r'\textbf{Relevance - [ %s ] - OS_10ye}' % (variq)
    ...
    for r in range(lenOfPicks):
        ...
        ax1.annotate(r'\textbf{%s [%s]}' % (scenarioall[r],count_os_10yesum[r]),xy=(0,0),xytext=(0.5,1.10),
                      textcoords='axes fraction',color='dimgrey',fontsize=8,
                      rotation=0,ha='center',va='center')
        ax1.annotate(r'\textbf{[%s]}' % letters[r],xy=(0,0),xytext=(0.86,0.97),
                      textcoords='axes fraction',color='k',fontsize=6,
    ...
    plt.savefig(directoryfigure + 'LRPComposites_%s_OS_10ye_ensemblemean.png' % (savename),dpi=300)
    ...
    limit = np.arange(0,0.61,0.005)
    barlim = np.round(np.arange(0,0.61,0.2),2)
    cmap = cmr.dusk
    label = r'\textbf{Relevance Range - [ %s ] - OS}' % (variq)
    ...
    for r in range(lenOfPicks):
        ...
        if count_os_sum[r] > 2:
            ...
            ax1.annotate(r'\textbf{%s [%s]}' % (scenarioall[r],np.nan),xy=(0,0),xytext=(0.5,1.10),
                          textcoords='axes fraction',color='dimgrey',fontsize=8,
                          rotation=0,ha='center',va='center')
        ax1.annotate(r'\textbf{[%s]}' % letters[r],xy=(0,0),xytext=(0.86,0.97),
                      textcoords='axes fraction',color='k',fontsize=6,
    ...
    plt.savefig(directoryfigure + 'LRPComposites_%s_OS_ensemblerange.png' % (savename),dpi=300)
    ...
    barlim = np.round(np.arange(0,0.61,0.2),2)
    cmap = cmr.dusk
    label = r'\textbf{Relevance Range - [ %s ] - OS_10ye}' % (variq)
    ...
    plt.savefig(directoryfigure + 'LRPComposites_%s_OS_10ye_ensemblerange.png' % (savename),dpi=300)
