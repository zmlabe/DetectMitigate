"""
Examine relationship between RH and heatwaves with SSP585
...
name_osHEAT = 'HeatStats/HeatStats' + '_JJA_' + reg_name_vari + '_' + 'TMIN' + '_' + 'SPEAR_MED_SSP534OS' + '.nc'
...
directorydatahHEAT = '/work/Zachary.Labe/Research/DetectMitigate/DataExtremes/'
name_os10yeHEAT = 'HeatStats/HeatStats' + '_JJA_' + reg_name_vari + '_' + 'TMIN' + '_' + 'SPEAR_MED_SSP534OS_10ye' + '.nc'
...
plt.yticks(np.arange(-50,51,2),map(str,np.round(np.arange(-50,51,2),2)),fontsize=10)
plt.xlim([0,80])
plt.ylim([-14,8])

plt.xlabel(r'\textbf{Count of Tn90 days in JJA - %s}' % reg_name_vari,fontsize=11,color='dimgrey')
...
plt.tight_layout()
plt.savefig(directoryfigure + 'Scatter_RH-Tn90_OS_%s_ssp585.png' % reg_name_vari,dpi=300)
