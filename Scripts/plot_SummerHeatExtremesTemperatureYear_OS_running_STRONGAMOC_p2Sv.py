...
experimentnames = ['SSP5-34OS','SSP5-34OS_AMOC','SSP5-34OS minus SSP5-34OS_AMOC_p2Sv']
seasons = ['JJA']
slicemonthnamen = ['JJA']
...
plt.savefig(directoryfigure + 'SummerHeatExtremesTemperatureYear_OS-T2M_%s_%s_running-%syr_%s_AMOC_p2Sv.png' % (variq,seasons[0],rolling_years,varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerHeatExtremesTemperatureYear-Difference_OS-T2M_%s_%s_running-%syr_%s_AMOC_p2Sv.png' % (variq,seasons[0],rolling_years,varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerHeatExtremesTemperatureYear-Benefit_OS-T2M_%s_%s_running-%syr_%s_AMOC_p2Sv.png' % (variq,seasons[0],rolling_years,varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerHeatExtremesTemperatureYear-BenefitMask_OS-%s_%s_running-%syr_%s_AMOC_p2Sv.png' % (variq,seasons[0],rolling_years,varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerHeatExtremesTemperatureYear-BenefitMask_OS-%s_%s_running-%syr_%s_land_AMOC_p2Sv.png' % (variq,seasons[0],rolling_years,varcount),dpi=300)
