"""
Calculate trend for OS for the calculated latent heat flux but just for the CONUS
...
spear_m = 1000 * 2.45e6 * spear_mALLe * (1/86400) * (1/1000)
spear_h = 1000 * 2.45e6 * spear_hALLe * (1/86400) * (1/1000)
spear_osm = 1000 * 2.45e6 * spear_osmALLe * (1/86400) * (1/1000)
spear_osm_10ye = 1000 * 2.45e6 * spear_osm_10yeALLe * (1/86400) * (1/1000)
...
label = r'\textbf{LATENT HEAT FLUX [W/m$^{2}$]}' 
...
plt.savefig(directoryfigure + 'GWL-%s_%s_%s_CONUS.png' % (selectGWLn,'LHFLX',seasons[0]),dpi=300)
