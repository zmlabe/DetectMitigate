"""
Calculate GWL for different variables for the strong amoc run
...
if variq == 'T2M':
    ...
    spear_osm_AMOCt,lats,lons = read_primary_dataset('T2M','SPEAR_MED_SSP534OS_STRONGAMOC_p1Sv',monthlychoice,'SSP534OS_STRONGAMOC_p1Sv',lat_bounds,lon_bounds)
    lon2,lat2 = np.meshgrid(lons,lats)
...
plt.savefig(directoryfigure + 'GWL-%s_%s_%s_AMOC_p1Sv.png' % (selectGWLn,variq,seasons[0]),dpi=300)
