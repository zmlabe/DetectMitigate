"""
Plots timeseries of precipitation over central Africa
...
plt.ylabel(r'\textbf{Central Africa PRECT [mm/day]}',
            fontsize=10,color='k')
plt.title(r'\textbf{CENTRAL AFRICA %s' % variq,fontsize=15,color='dimgrey')

plt.tight_layout()
plt.savefig(directoryfigure + 'CentralAfrica_%s_EmissionScenarios_%s.png' % (variq,monthlychoice),dpi=300)
