...
plt.title(r'\textbf{(a) LM4.2 -- LM4; Count Tx90; 1921-1950}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(b) LM4.2 -- LM4; Count Tx99; 1921-1950}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(c) LM4.2 -- LM4; Count Tx90; 2041-2070}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(d) LM4.2 -- LM4; Count Tx99; 2041-2070}',fontsize=11,color='dimgrey')
...
plt.savefig(directoryfigure + 'ComparisonHeatExtremes_LM42_US_JJA.png',dpi=300)
...
plt.title(r'\textbf{(a) SPEAR_MED; Count Tx90; 1921-1950}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(b) SPEAR_MED_LM42; Count Tx90; 1921-1950}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(c) SPEAR_MED; Count Tx90; 2041-2070}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(d) SPEAR_MED_LM42; Count Tx90; 2041-2070}',fontsize=11,color='dimgrey')
...
plt.savefig(directoryfigure + 'ComparisonHeatExtremesCount90_LM42_US_JJA.png',dpi=300)
...
plt.title(r'\textbf{(a) SPEAR_MED; Count Tx99; 1921-1950}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(b) SPEAR_MED_LM42; Count Tx99; 1921-1950}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(c) SPEAR_MED; Count Tx99; 2041-2070}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(d) SPEAR_MED_LM42; Count Tx99; 2041-2070}',fontsize=11,color='dimgrey')
...
plt.savefig(directoryfigure + 'ComparisonHeatExtremesCount99_LM42_US_JJA.png',dpi=300)
...
plt.savefig(directoryfigure + 'ComparisonHeatExtremes_LM42_Globe_JJA.png',dpi=300)
...
plt.savefig(directoryfigure + 'ComparisonHeatExtremes_LM42_Globe-Land_JJA.png',dpi=300)
