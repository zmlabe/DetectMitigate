"""
Function reads in monthly data from ERA5 for HIGHS data
...
Usage
-----
    [1] read_ERA5_monthlyHIGHS(variq,directory,sliceperiod,sliceyear,
                  sliceshape,addclimo,slicenan,level)
"""

def read_ERA5_monthlyHIGHS(variq,directory,sliceperiod,sliceyear,sliceshape,addclimo,slicenan,level):
    """
    ...
    Usage
    -----
    lat,lon,lev,var = read_ERA5_monthlyHIGHS(variq,directory,sliceperiod,sliceyear,
                            sliceshape,addclimo,slicenan,level)
    """
    print('\n>>>>>>>>>> STARTING read_ERA5_monthlyHIGHS function!')
    ...
    if level == 'surface':
        ...
        filename = 'ERA5_HIGHS/%s_1979-2021.nc' % variq
    ...
    print('>>>>>>>>>> ENDING read_ERA5_monthlyHIGHS function for -- %s!' % variq)
...
# addclimo = True
# level = 'surface'
# lat,lon,lev,var = read_ERA5_monthlyHIGHS(variq,directory,sliceperiod,
