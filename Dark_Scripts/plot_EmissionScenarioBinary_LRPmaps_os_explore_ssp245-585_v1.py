...
###############################################################################
############################################################################### 
### Find transition from SSP245 to SSP585
os_years = yearsall[0]
os_10ye_years = yearsall[0]

transition_osq = np.where((os_years >= 2055) & (os_years <= 2060))[0]
transition_10ye_osq = np.where((os_10ye_years >= 2042) & (os_10ye_years <= 2047))[0]
...
plt.savefig(directoryfigure + 'LRPComposites_%s_OS_exploreTransitions.png' % (savename),dpi=300)
...
plt.plot(os_years,ave_NA_os,color='teal',marker='o',linewidth=1,label=r'%s' % experimentnames[0],clip_on=False)
plt.plot(os_10ye_years,ave_NA_os_10ye,color='maroon',marker='o',linewidth=3,label=r'%s' % experimentnames[1],clip_on=False)
...
plt.ylabel(r'\textbf{Relevance}',color='dimgrey',fontsize=8,labelpad=8)
plt.title(r'\textbf{LRP Relevance over the North Atlantic for %s}' % (variq),color='dimgrey',fontsize=10)

plt.tight_layout()
plt.subplots_adjust(bottom=0.15)
plt.savefig(directoryfigure + '%s_NorthAtlantic_Relevance.png' % (savename),dpi=300)
...
plt.plot(os_years,ave_NA_os_perc*100,color='teal',marker='o',linewidth=1,label=r'%s' % experimentnames[0],clip_on=False)
plt.plot(os_10ye_years,ave_NA_os_perc_10ye*100,color='maroon',marker='o',linewidth=3,label=r'%s' % experimentnames[1],clip_on=False)
...
plt.ylabel(r'\textbf{Percentile of Relevance}',color='dimgrey',fontsize=8,labelpad=8)
plt.title(r'\textbf{LRP Percentile over the North Atlantic for %s}' % (variq),color='dimgrey',fontsize=10)

plt.tight_layout()
plt.subplots_adjust(bottom=0.15)
plt.savefig(directoryfigure + '%s_NorthAtlantic_PercentileRelevance.png' % (savename),dpi=300)
...
plt.ylabel(r'\textbf{Relevance}',color='dimgrey',fontsize=8,labelpad=8)
plt.title(r'\textbf{LRP Relevance over the Northern North Atlantic for %s}' % (variq),color='dimgrey',fontsize=10)

plt.tight_layout()
plt.subplots_adjust(bottom=0.15)
plt.savefig(directoryfigure + '%s_NorthNorthAtlantic_Relevance.png' % (savename),dpi=300)
...
plt.ylabel(r'\textbf{Percentile of Relevance}',color='dimgrey',fontsize=8,labelpad=8)
plt.title(r'\textbf{LRP Percentile over the Northern North Atlantic for %s}' % (variq),color='dimgrey',fontsize=10)

plt.tight_layout()
plt.subplots_adjust(bottom=0.15)
plt.savefig(directoryfigure + '%s_NorthNorthAtlantic_PercentileRelevance.png' % (savename),dpi=300)
...
plt.ylabel(r'\textbf{Relevance}',color='dimgrey',fontsize=8,labelpad=8)
plt.title(r'\textbf{LRP Relevance over Central Africa for %s}' % (variq),color='dimgrey',fontsize=10)

plt.tight_layout()
plt.subplots_adjust(bottom=0.15)
plt.savefig(directoryfigure + '%s_CentralAfrica_Relevance.png' % (savename),dpi=300)
...
plt.ylabel(r'\textbf{Percentile of Relevance}',color='dimgrey',fontsize=8,labelpad=8)
plt.title(r'\textbf{LRP Percentile over Central Africa for %s}' % (variq),color='dimgrey',fontsize=10)

plt.tight_layout()
plt.subplots_adjust(bottom=0.15)
plt.savefig(directoryfigure + '%s_Central Africa_PercentileRelevance.png' % (savename),dpi=300)
