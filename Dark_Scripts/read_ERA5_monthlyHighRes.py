...
Usage
-----
    [1] read_ERA5_monthlyHighRes(variq,directory,sliceperiod,sliceyear,
                  sliceshape,addclimo,slicenan,newon)
"""

def read_ERA5_monthlyHighRes(variq,directory,sliceperiod,sliceyear,sliceshape,addclimo,slicenan):
    """
    ...
    filename = 'ERA5_025x025/%s_1979-2021.nc' % variq
    ...
    print('>>>>>>>>>> ENDING read_ERA5_monthlyHighRes function for -- %s!' % variq)
...
# slicenan = 'nan'
# addclimo = True
# lat,lon,var = read_ERA5_monthlyHighRes(variq,directory,sliceperiod,
