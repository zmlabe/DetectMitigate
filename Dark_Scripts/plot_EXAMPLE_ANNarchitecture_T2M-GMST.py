...
for i in range(5,7): 
    if i == 0:
        c = 'k'
        plt.text(1940,0.6,r'\textbf{HISTORICAL FORCING}',fontsize=10,color=c,
        rotation=0)
    elif i == 1:
        c = cmocean.cm.balance(0.2)
        plt.text(2040,0.22,r'\textbf{NATURAL FORCING}',fontsize=10,color=c)
    elif i == 2:
        c = cmocean.cm.balance(0.95)
        plt.text(2075,4.25,r'\textbf{SSP5-8.5}',fontsize=10,color=c,rotation=40)
    elif i == 3:
        c = cmocean.cm.balance(0.7)
        plt.text(2075,1.5,r'\textbf{SSP1-1.9}',fontsize=10,color=c,rotation=-5)
    elif i == 4:
        c = cmocean.cm.balance(0.85)
        plt.text(2075,2.85,r'\textbf{SSP2-4.5}',fontsize=10,color=c,rotation=10)
    elif i == 5:
        c = 'maroon'
        plt.text(2075,2.43,r'\textbf{SSP5-3.4OS}',fontsize=10,color=c,rotation=-20)
    elif i == 6:
        c = 'teal'
        plt.text(2075,0.9,r'\textbf{SSP5-3.4OS_10ye}',fontsize=10,color=c,rotation=-20)
...
plt.tight_layout()
plt.savefig(directoryfigure + 'GMST_EmissionScenarios_%s_NOos_os.png' % monthlychoice,
