"""
Function(s) reads in monthly data from LENS2_LOWS for different variables 
using 100 ensemble members for all time periods using SPEAR_LOW resolution
...
Usage
-----
    [1] read_LENS2_LOWS(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
"""

def read_LENS2_LOWS(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper):
    """
    Function reads monthly data from LENS2_LOWS
    ...
    Usage
    -----
    read_LENS2_LOWS(directory,vari,sliceperiod,sliceshape,
                             slicenan,numOfEns,timeper)
    """
    print('\n>>>>>>>>>> STARTING read_LENS2_LOWS function!')
    ...
    for i,ensmember in enumerate(ens):
        filename1 = directory + '%s/%s_%03d_1850-2100.nc' % (vari,vari,
                                                          ensmember)
        ...
        print('Completed: read *LENS2_LOWS historical* Ensemble Member --%s-- for %s' % (ensmember,vari))
    ...
    del membersvar
    print('Completed: read all LENS2_LOWS Members!\n')
    ...
    print('>>>>>>>>>> ENDING read_LENS2_LOWS function!')    
...
# import calc_Utilities as UT
# directory = '/work/Zachary.Labe/Data/LENS2_LOWS/monthly/'
# vari = 'T2M'
# sliceperiod = 'annual'
# sliceshape = 4
# slicenan = 'nan'
# numOfEns = 100
# timeper = 'all'
# lat,lon,var = read_LENS2_LOWS(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
