...
plt.axvline(x=2040,linewidth=1.5,color='darkslategrey')
plt.axvline(x=2031,linewidth=1.5,color='lightseagreen')
...
plt.xticks(np.arange(1920,2101,10),np.arange(1920,2101,10),fontsize=7)
...
leg = plt.legend(shadow=False,fontsize=12,loc='upper center',
      bbox_to_anchor=(0.23,1.045),fancybox=True,ncol=1,frameon=False,
      handlelength=1,handletextpad=0.5)
for line,text in zip(leg.get_lines(), leg.get_texts()):
    text.set_color(line.get_color())

plt.xticks(np.arange(1920,2101,10),np.arange(1920,2101,10),fontsize=7)
plt.yticks(np.round(np.arange(0,5000,200),2),np.round(np.arange(0,5000,200),2),fontsize=7)
plt.xlim([1920,2100])
plt.ylim([800,3000])
...
plt.xticks(np.arange(1920,2101,10),np.arange(1920,2101,10),fontsize=7)
plt.yticks(np.round(np.arange(0,5000,10),2),np.round(np.arange(0,5000,10),2),fontsize=7)
plt.xlim([1920,2100])
plt.ylim([280,400])
...
### Save figure
plt.savefig(directoryfigure+'MSFigure_ANN_TimeSeries_GHG.png',dpi=600)
