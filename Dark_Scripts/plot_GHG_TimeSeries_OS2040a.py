...
### Read in SSP370_OS2040a data
data = Dataset(directorydata + 'SPEAR_MED_SSP370_OS2040a/monthly/CO2/CO2_01_2041-2100.nc')
OS2040a_co2_f = data.variables['CO2'][:]
data.close()
data = Dataset(directorydata + 'SPEAR_MED_SSP370_OS2040a/monthly/CH4/CH4_01_2041-2100.nc')
OS2040a_ch4_f = data.variables['CH4'][:]
data.close()
data = Dataset(directorydata + 'SPEAR_MED_SSP370_OS2040a/monthly/N2O/N2O_01_2041-2100.nc')
OS2040a_n2o_f = data.variables['N2O'][:]
data.close()
...
### Combine OS2040a
diffmo_OS2040a = len(SSP370_n2o_f) - len(OS2040a_n2o_f)
OS2040a_co2_allf = np.append(SSP370_co2_f[:diffmo_OS2040a],OS2040a_co2_f,axis=0).reshape(len(yearsall),12)
OS2040a_ch4_allf = np.append(SSP370_ch4_f[:diffmo_OS2040a],OS2040a_ch4_f,axis=0).reshape(len(yearsall),12)
OS2040a_n2o_allf = np.append(SSP370_n2o_f[:diffmo_OS2040a],OS2040a_n2o_f,axis=0).reshape(len(yearsall),12)
...
OS2040a_co2_allf_a = np.nanmean(OS2040a_co2_allf,axis=1)
OS2040a_ch4_allf_a = np.nanmean(OS2040a_ch4_allf,axis=1)
OS2040a_n2o_allf_a = np.nanmean(OS2040a_n2o_allf,axis=1)
...
plt.plot(years,os_co2_f_a,linestyle='-',linewidth=2,color='darkslategrey',
          label=r'\textbf{SPEAR_MED_SSP534OS}',clip_on=False)
plt.plot(years[diffmo//12:],os_10ye_co2_allf_a[diffmo//12:],linestyle='--',linewidth=2,color='teal',
          label=r'\textbf{SPEAR_MED_SSP534OS_10ye}',clip_on=False,dashes=(1,0.3))

plt.plot(years,SSP370_co2_f_a,linestyle='-',linewidth=3.5,color='darkorange',
          label=r'\textbf{SPEAR_MED_SSP370}',clip_on=False)
plt.plot(years,OS2040a_co2_allf_a,linestyle='-',linewidth=2,color='gold',
...
plt.plot(yearstotal,ch4_spear_a,linestyle='-',linewidth=3.5,color='maroon',
          label=r'\textbf{SPEAR_MED_SSP585}',clip_on=False)
plt.plot(years,os_ch4_f_a,linestyle='-',linewidth=2,color='darkslategrey',
          label=r'\textbf{SPEAR_MED_SSP534OS}',clip_on=False)
plt.plot(years[diffmo//12:],os_10ye_ch4_allf_a[diffmo//12:],linestyle='--',linewidth=2,color='teal',
          label=r'\textbf{SPEAR_MED_SSP534OS_10ye}',clip_on=False,dashes=(1,0.3))

plt.plot(years,SSP370_ch4_f_a,linestyle='-',linewidth=3.5,color='darkorange',
          label=r'\textbf{SPEAR_MED_SSP370}',clip_on=False)
plt.plot(years,OS2040a_ch4_allf_a,linestyle='-',linewidth=2,color='gold',
          label=r'\textbf{SPEAR_MED_SSP370_OS2040a}',clip_on=False)
...
plt.plot(yearstotal,n2o_spear_a,linestyle='-',linewidth=3.5,color='maroon',
          label=r'\textbf{SPEAR_MED_SSP585}',clip_on=False)
plt.plot(years,os_n2o_f_a,linestyle='-',linewidth=2,color='darkslategrey',
          label=r'\textbf{SPEAR_MED_SSP534OS}',clip_on=False)
plt.plot(years[diffmo//12:],os_10ye_n2o_allf_a[diffmo//12:],linestyle='--',linewidth=2,color='teal',
          label=r'\textbf{SPEAR_MED_SSP534OS_10ye}',clip_on=False,dashes=(1,0.3))

plt.plot(years,SSP370_n2o_f_a,linestyle='-',linewidth=3.5,color='darkorange',
          label=r'\textbf{SPEAR_MED_SSP370}',clip_on=False)
plt.plot(years,OS2040a_n2o_allf_a,linestyle='-',linewidth=2,color='gold',
          label=r'\textbf{SPEAR_MED_SSP370_OS2040a}',clip_on=False)
...
### Save figure
plt.savefig(directoryfigure+'GHG_TimeSeries_OS2040a.png',dpi=300)
