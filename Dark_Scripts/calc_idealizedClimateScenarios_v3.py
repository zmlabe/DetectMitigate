...
directoryoutput = '/home/Zachary.Labe/Research/DetectMitigate/Data/v3/'
...
p3_S2020 = [yearq_S2020+40,co2_spear[yearq_S2020+40]]
...
p3_S2020_ch4 = [yearq_S2020+120,ch4_spear[yearq_S2020]-220]
...
# p2_S2020_ch4 = [len(yearstotal_extend)*12,ch4_spear[0]]
# length_S2020_ch4 = (len(yearstotal_extend)*12) - yearq_S2020
# p3_S2020_ch4 = [yearq_S2020+80,ch4_spear[yearq_S2020-180]]
# x_S2020_ch4, y_S2020_ch4 = draw_curve(p1_S2020_ch4, p2_S2020_ch4, p3_S2020_ch4, length_S2020_ch4)
...
### Save figure
plt.savefig(directoryfigure+'TimeSeries_All-Scenarios_GHG_hypothetical_v3.png',dpi=600)
...
def concFiles_co2(data,startyr,spear,yearstotal_extend):
    ...
    np.savetxt(directoryoutput + 'co2_gblannualdata_SSP370-OS%sp1curve_from_wfc' % startyr,
...
def concFiles_ch4(data,startyr,spear,yearstotal_extend):
    ...
    np.savetxt(directoryoutput + 'ch4_gblannualdata_SSP370-OS%sp1curve_from_wfc' % startyr,
