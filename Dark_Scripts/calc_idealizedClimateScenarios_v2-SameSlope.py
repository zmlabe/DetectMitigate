...
p3_S2020_ch4 = [yearq_S2020,ch4_spear[yearq_S2020]]
...
### Save figure
plt.savefig(directoryfigure+'TimeSeries_All-Scenarios_GHG_hypothetical_v2-SameSlope.png',dpi=600)
...
def concFiles_co2(data,startyr,spear,yearstotal_extend):
    ...
    np.savetxt(directoryoutput + 'co2_gblannualdata_ssp%sos_from_wfc' % startyr,
...
def concFiles_ch4(data,startyr,spear,yearstotal_extend):
    ...
    np.savetxt(directoryoutput + 'ch4_gblannualdata_ssp%sos_from_wfc' % startyr,
