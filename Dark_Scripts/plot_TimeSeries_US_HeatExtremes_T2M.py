"""
Calculate timeseries of US means of T2M 
...
plt.ylabel(r'\textbf{Frequency of T2M-Tx90 over CONUS [Percent]}',fontsize=7,color='k')
...
plt.ylabel(r'\textbf{Frequency of T2M-Tx95 over CONUS [Percent]}',fontsize=7,color='k')
