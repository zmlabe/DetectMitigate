...
plt.ylabel(r'\textbf{Frequency of Tn90 over CONUS [Percent]}',fontsize=7,color='k')

plt.tight_layout()
plt.savefig(directoryfigure + 'TimeSeries_Tn90_%s_%s_LM42.png' % (seasons[0],reg_name),dpi=300)
...
plt.ylabel(r'\textbf{Frequency of Tn95 over CONUS [Percent]}',fontsize=7,color='k')

plt.tight_layout()
plt.savefig(directoryfigure + 'TimeSeries_Tn95_%s_%s_LM42.png' % (seasons[0],reg_name),dpi=300)
