...
label = r'\textbf{TMIN Var. [$^{\circ}$C$^{2}$]}'
...
###############################################################################
label = r'\textbf{TMIN Var. Difference [$^{\circ}$C$^{2}$]}'
...
plt.savefig(directoryfigure + 'varianceChange_LM42_1921-1950_TMIN.png',dpi=300)
