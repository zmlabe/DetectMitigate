"""
Plots timeseries of temperature over central Africa
...
plt.title(r'\textbf{CENTRAL AFRICA',fontsize=30,color='w')

plt.tight_layout()
plt.savefig(directoryfigure + 'PRESENTATION_CentralAfrica_%s_EmissionScenarios_%s.png' % (variq,monthlychoice),dpi=300)
