...
plt.savefig(directoryfigure + 'SummerHeatExtremesTemperatureYear_OS-T2M_%s_%s_%s_US.png' % (variq,seasons[0],varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerHeatExtremesTemperatureYear-Difference_OS-T2M_%s_%s_%s_US.png' % (variq,seasons[0],varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerHeatExtremesTemperatureYear-Benefit_OS-T2M_%s_%s_%s_US.png' % (variq,seasons[0],varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerHeatExtremesTemperatureYear-BenefitMask_OS-%s_%s_%s_US.png' % (variq,seasons[0],varcount),dpi=300)
