...
plt.ylabel(r'\textbf{Confidence}',color='darkgrey',fontsize=8,labelpad=8)
plt.title(r'\textbf{ANN CONFIDENCE OF SSP534OS -- %s}' % (variq),color='w',fontsize=10)

plt.tight_layout()
plt.subplots_adjust(bottom=0.15)
plt.savefig(directoryfigure + 'PRESENTATION_%s_Confidence.png' % (savename),dpi=300)
...
plt.savefig(directoryfigure + 'PRESENTATION_%s_NumberOfEnsChoices.png' % (savename),dpi=300)
