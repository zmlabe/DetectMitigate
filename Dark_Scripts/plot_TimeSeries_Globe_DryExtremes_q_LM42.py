...
plt.ylabel(r'\textbf{Frequency of qx10-Dry over Globe [Percent]}',fontsize=7,color='k')
...
plt.ylabel(r'\textbf{Frequency of qx05-Dry over Globe [Percent]}',fontsize=7,color='k')
