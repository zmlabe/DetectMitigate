...
plt.title(r'\textbf{NORTH ATLANTIC',fontsize=15,color='w')

plt.tight_layout()
plt.savefig(directoryfigure + 'PRESENTATION_NorthAtlantic_%s_EmissionScenarios_%s.png' % (variq,monthlychoice),dpi=300)
...
# plt.plot(yearsall[0],ave_NA_data_os[-1],linestyle='--',linewidth=0.8,color='b',
#          clip_on=False,zorder=3,dashes=(1,0.3))
# plt.plot(yearsall[1],ave_NA_data_os_10ye[-1],linestyle='--',linewidth=0.8,color='r',
#          clip_on=False,zorder=3,dashes=(1,0.3))
...
plt.ylabel(r'\textbf{2-m Temperature [$^{\circ}$C]}',
           fontsize=10,color='darkgrey')
plt.title(r'\textbf{NORTHERN NORTH ATLANTIC',fontsize=15,color='w')

plt.tight_layout()
plt.savefig(directoryfigure + 'PRESENTATION_NorthNorthAtlantic_%s_EmissionScenarios_%s.png' % (variq,monthlychoice),dpi=300)
