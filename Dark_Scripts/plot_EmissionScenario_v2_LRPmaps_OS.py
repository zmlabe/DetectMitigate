...
Version    : 2 - added XAI capability
"""
...
for va in range(len(variablesall)):
    ...
    for r in range(lenOfPicks):
        ...
        ax1.annotate(r'\textbf{%s, [%s]}' % (scenarioall[r],len(predos_test[r])),xy=(0,0),xytext=(0.5,1.10),
    ...
    plt.savefig(directoryfigure + 'LRPComposites_%s_OS.png' % (savename),dpi=300)
    ...
    for r in range(lenOfPicks):
        ...
        ax1.annotate(r'\textbf{%s, [%s]}' % (scenarioall[r],len(predos_10ye_test[r])),xy=(0,0),xytext=(0.5,1.10),
                      textcoords='axes fraction',color='dimgrey',fontsize=8,
                      rotation=0,ha='center',va='center')
        ax1.annotate(r'\textbf{[%s]}' % letters[r],xy=(0,0),xytext=(0.86,0.97),
                      textcoords='axes fraction',color='k',fontsize=6,
    ...
    plt.savefig(directoryfigure + 'LRPComposites_%s_OS_10ye.png' % (savename),dpi=300)
