"""
Function reads in monthly data from ERA5 for MEDS data
...
Usage
-----
    [1] read_ERA5_monthlyMEDS(variq,directory,sliceperiod,sliceyear,
                  sliceshape,addclimo,slicenan,level)
"""

def read_ERA5_monthlyMEDS(variq,directory,sliceperiod,sliceyear,sliceshape,addclimo,slicenan,level):
    """
    ...
    Usage
    -----
    lat,lon,lev,var = read_ERA5_monthlyMEDS(variq,directory,sliceperiod,sliceyear,
                            sliceshape,addclimo,slicenan,level)
    """
    print('\n>>>>>>>>>> STARTING read_ERA5_monthlyMEDS function!')
    ...
    if level == 'surface':
        ...
        filename = 'ERA5_MEDS/%s_1940-2022.nc' % variq
    ...
    elif any([variq=='T2M',variq=='SST',variq=='TMAX',variq=='TMIN',variq=='TS']):
        varshape = varshape - 273.15 # K to C
        print('Completed: Changed units (K to C)!')
    elif any([variq=='P',variq=='PRECL',variq=='PRECC',variq=='WA',variq=='EVAP',variq=='SNOWRATE']):
        varshape = varshape*1000 # m/day to mm/day
        ### "Average Monthly Rate of Precipitation"
        print('*** CURRENT UNITS ---> [[ mm/day ]]! ***')
        
    print('>>>>>>>>>> ENDING read_ERA5_monthlyMEDS function for -- %s!' % variq)
...
# sliceperiod = 'annual'
# sliceyear = np.arange(1940,2022+1,1)
# sliceshape = 4
# slicenan = 'nan'
# addclimo = True
# level = 'vertical'
# lat,lon,lev,var = read_ERA5_monthlyMEDS(variq,directory,sliceperiod,
