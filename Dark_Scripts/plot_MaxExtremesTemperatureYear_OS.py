...
for the maximum of monthly max temperatures
...
plt.savefig(directoryfigure + 'MaxTemperatureYear_OS-T2M_%s_%s.png' % (variq,seasons[0]),dpi=300)
...
plt.savefig(directoryfigure + 'MaxTemperatureYear-Difference_OS-T2M_%s_%s.png' % (variq,seasons[0]),dpi=300)
...
plt.savefig(directoryfigure + 'MaxTemperatureYear-Benefit_OS-T2M_%s_%s.png' % (variq,seasons[0]),dpi=300)
...
plt.savefig(directoryfigure + 'MaxTemperatureYear-BenefitMask_OS-%s_%s.png' % (variq,seasons[0]),dpi=300)
