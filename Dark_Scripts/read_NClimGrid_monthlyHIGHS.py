"""
Function reads in monthly data from NClimGrid for HIGHS data
...
Usage
-----
    [1] read_NClimGrid_monthlyHIGHS(variq,directory,sliceperiod,sliceyear,
                                   sliceshape,slicenan)
"""

def read_NClimGrid_monthlyHIGHS(variq,directory,sliceperiod,sliceyear,sliceshape,slicenan):
    """
    ...
    Usage
    -----
    lat,lon,lev,var = read_NClimGrid_monthlyHIGHS(variq,directory,sliceperiod,sliceyear,
                                                 sliceshape,slicenan)
    """
    print('\n>>>>>>>>>> STARTING read_NClimGrid_monthlyHIGHS function!')
    ...
    filename = 'NClimGrid_HIGHS/%s_1895-2021.nc' % variq
    ...
    print('>>>>>>>>>> ENDING read_NClimGrid_monthlyHIGHS function for -- %s!' % variq)
...
# sliceshape = 3
# slicenan = 'nan'
# lat,lon,var = read_NClimGrid_monthlyHIGHS(variq,directory,sliceperiod,
