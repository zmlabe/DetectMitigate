...
plt.ylabel(r'\textbf{Relative Humidity Anomaly [\%%; 1921-1950; %s]}' % (seasons[0]),
            fontsize=7,color='k')

plt.tight_layout()
plt.savefig(directoryfigure + 'TimeSeries_CONUS_RH_historicalbaseline_%s.png' % (seasons[0]),dpi=300)
