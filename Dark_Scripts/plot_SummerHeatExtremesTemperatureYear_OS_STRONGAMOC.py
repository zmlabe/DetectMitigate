...
experimentnames = ['SSP5-34OS','SPEAR_MED_SSP534OS_STRONGAMOC_p1Sv','SSP5-34OS minus SPEAR_MED_SSP534OS_STRONGAMOC_p1Sv']
seasons = ['JJA']
slicemonthnamen = ['JJA']
...
plt.savefig(directoryfigure + 'SummerHeatExtremesTemperatureYear_OS-T2M_%s_%s_%s_AMOC_p1Sv.png' % (variq,seasons[0],varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerHeatExtremesTemperatureYear-Difference_OS-T2M_%s_%s_%s_AMOC_p1Sv.png' % (variq,seasons[0],varcount),dpi=300)
...
ax1.annotate(r'\textbf{argmax(SSP5-34OS_AMOC_p1Sv) - argmin(SSP5-34OS)}',xy=(0,0),xytext=(0.5,1.10),
              textcoords='axes fraction',color='dimgrey',fontsize=14,
              rotation=0,ha='center',va='center')
ax1.annotate(r'\textbf{[%s]}' % letters[r],xy=(0,0),xytext=(0.86,0.97),
              textcoords='axes fraction',color='k',fontsize=6,
...
plt.savefig(directoryfigure + 'SummerHeatExtremesTemperatureYear-Benefit_OS-T2M_%s_%s_%s_AMOC_p1Sv.png' % (variq,seasons[0],varcount),dpi=300)
...
plt.savefig(directoryfigure + 'SummerHeatExtremesTemperatureYear-BenefitMask_OS-%s_%s_%s_AMOC_p1Sv.png' % (variq,seasons[0],varcount),dpi=300)
