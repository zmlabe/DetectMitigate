...
name = 'MoistStats/MoistStats' + '_JJA_' + reg_name + '_' + variq + '_' + 'SPEAR_MED' + '.nc'
...
directorydatah = '/work/Zachary.Labe/Research/DetectMitigate/DataExtremes/'
name_LM42 = 'MoistStats/MoistStats' + '_JJA_' + reg_name + '_' + variq + '_' + 'SPEAR_MED_LM42p2_test' + '.nc'
...
plt.title(r'\textbf{(a) LM4.2 -- LM4; Count qx10; 1921-1950}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(b) LM4.2 -- LM4; Count qx01; 1921-1950}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(c) LM4.2 -- LM4; Count qx10; 2041-2070}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(d) LM4.2 -- LM4; Count qx01; 2041-2070}',fontsize=11,color='dimgrey')
...
plt.savefig(directoryfigure + 'ComparisonDryExtremes_LM42_US_JJA.png',dpi=300)
...
plt.title(r'\textbf{(a) SPEAR_MED; Count qx10; 1921-1950}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(b) SPEAR_MED_LM42; Count qx10; 1921-1950}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(c) SPEAR_MED; Count qx10; 2041-2070}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(d) SPEAR_MED_LM42; Count qx10; 2041-2070}',fontsize=11,color='dimgrey')
...
plt.savefig(directoryfigure + 'ComparisonDryExtremesCount90_LM42_US_JJA.png',dpi=300)
...
plt.title(r'\textbf{(a) SPEAR_MED; Count qx01; 1921-1950}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(b) SPEAR_MED_LM42; Count qx01; 1921-1950}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(c) SPEAR_MED; Count qx01; 2041-2070}',fontsize=11,color='dimgrey')
...
plt.title(r'\textbf{(d) SPEAR_MED_LM42; Count qx01; 2041-2070}',fontsize=11,color='dimgrey')
...
plt.savefig(directoryfigure + 'ComparisonDryExtremesCount99_LM42_US_JJA.png',dpi=300)
...
plt.savefig(directoryfigure + 'ComparisonDryExtremes_LM42_Globe_JJA.png',dpi=300)
...
plt.savefig(directoryfigure + 'ComparisonDryExtremes_LM42_Globe-Land_JJA.png',dpi=300)
