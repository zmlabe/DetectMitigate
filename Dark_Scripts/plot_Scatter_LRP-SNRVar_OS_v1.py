"""
Calculate VAR for SPEAR_MED and find relationship with LRP
...
lrp_scatter_VAR_os_pos = spear_stdtrend_os * pos_lrp_os
lrp_scatter_VAR_os_pos[np.where(lrp_scatter_VAR_os_pos == 0)] = np.nan
lrp_scatter_VAR_os_neg = spear_stdtrend_os * neg_lrp_os
lrp_scatter_VAR_os_neg[np.where(lrp_scatter_VAR_os_neg == 0)] = np.nan

lrp_scatter_VAR_os_10ye_pos = spear_stdtrend_os_10ye * pos_lrp_os_10ye
lrp_scatter_VAR_os_10ye_pos[np.where(lrp_scatter_VAR_os_10ye_pos == 0)] = np.nan
lrp_scatter_VAR_os_10ye_neg = spear_stdtrend_os_10ye * neg_lrp_os_10ye
lrp_scatter_VAR_os_10ye_neg[np.where(lrp_scatter_VAR_os_10ye_neg == 0)] = np.nan
    
###########################################################################
###########################################################################
###########################################################################
### LRP scatter
VAR_xpos_os = lrp_scatter_VAR_os_pos.ravel()
tre_ypos_os = lrp_scatter_TREND_os_pos.ravel()
VAR_xneg_os = lrp_scatter_VAR_os_neg.ravel()
tre_yneg_os = lrp_scatter_TREND_os_neg.ravel()

VAR_xpos_os_10ye = lrp_scatter_VAR_os_10ye_pos.ravel()
tre_ypos_os_10ye = lrp_scatter_TREND_os_10ye_pos.ravel()
VAR_xneg_os_10ye = lrp_scatter_VAR_os_10ye_neg.ravel()
tre_yneg_os_10ye = lrp_scatter_TREND_os_10ye_neg.ravel()

maskpos_os = ~np.isnan(VAR_xpos_os) & ~np.isnan(tre_ypos_os)
slopepos_os, interceptpos_os, r_valuepos_os, p_valuepos_os, stdpos_err_os = sts.linregress(VAR_xpos_os[maskpos_os],tre_ypos_os[maskpos_os])
maskneg_os = ~np.isnan(VAR_xneg_os) & ~np.isnan(tre_yneg_os)
slopeneg_os, interceptneg_os, r_valueneg_os, p_valueneg_os, stdneg_err_os = sts.linregress(VAR_xneg_os[maskpos_os],tre_yneg_os[maskpos_os])

maskpos_os_10ye = ~np.isnan(VAR_xpos_os_10ye) & ~np.isnan(tre_ypos_os_10ye)
slopepos_os_10ye, interceptpos_os_10ye, r_valuepos_os_10ye, p_valuepos_os_10ye, stdpos_err_os_10ye = sts.linregress(VAR_xpos_os_10ye[maskpos_os_10ye],tre_ypos_os_10ye[maskpos_os_10ye])
maskneg_os_10ye = ~np.isnan(VAR_xneg_os_10ye) & ~np.isnan(tre_yneg_os_10ye)
slopeneg_os_10ye, interceptneg_os_10ye, r_valueneg_os_10ye, p_valueneg_os_10ye, stdneg_err_os_10ye = sts.linregress(VAR_xneg_os_10ye[maskpos_os_10ye],tre_yneg_os_10ye[maskpos_os_10ye])
...
plt.xlabel(r'\textbf{std(Trend) for SPEAR_MED_SSP534OS_10ye}',fontsize=11,color='dimgrey')
plt.ylabel(r'\textbf{Trend for SPEAR_MED_SSP534OS_10ye}',fontsize=11,color='dimgrey')

plt.tight_layout()
plt.savefig(directoryfigure + 'SCATTER_LRP-VARvar_SPEAR-MED-SSP534OS_v1_%s-%s.png' % (yrmin_os,yrmax_os),dpi=300)
...
plt.tight_layout()
plt.savefig(directoryfigure + 'SCATTER_LRP-VARvar_SPEAR-MED-SSP534OS_10ye_v1_%s-%s.png' % (yrmin_os,yrmax_os),dpi=300)
...
plt.xlabel(r'\textbf{std.dev. for SPEAR_MED_SSP534OS_10ye}',fontsize=11,color='dimgrey')
plt.ylabel(r'\textbf{Trend for SPEAR_MED_SSP534OS_10ye}',fontsize=11,color='dimgrey')

plt.tight_layout()
plt.savefig(directoryfigure + 'SCATTER_LRP-stdvar_SPEAR-MED-SSP534OS_v1_%s-%s.png' % (yrmin_os,yrmax_os),dpi=300)
...
plt.tight_layout()
plt.savefig(directoryfigure + 'SCATTER_LRP-stdvar_SPEAR-MED-SSP534OS_10ye_v1_%s-%s.png' % (yrmin_os,yrmax_os),dpi=300)
