"""
Calculate land ocean time series for GMST over Southern Hemisphere
...
plt.xlim([2030,2100])
plt.ylim([0,7])
plt.title(r'\textbf{SOUTHERN HEMISPHERE}',color='k',fontsize=15)

plt.ylabel(r'\textbf{Near-Surface Temperature Anomaly [$^{\circ}$C; 1921-1950]}',
            fontsize=10,color='k')

plt.tight_layout()
plt.savefig(directoryfigure + 'TimeSeries_GMST_GlobeLandOcean_SH.png',dpi=300)
...
plt.tight_layout()
plt.savefig(directoryfigure + 'TimeSeries_GMST_LandOcean_SH.png',dpi=300)
...
plt.xticks(np.arange(1920,2101,10),np.arange(1920,2101,10))
plt.yticks(np.round(np.arange(0,1.01,0.05),2),np.round(np.arange(0,1.01,0.05),2))
plt.xlim([2015,2100])
plt.ylim([0,0.4])
...
plt.tight_layout()
plt.savefig(directoryfigure + 'TimeSeries_CV_GlobeLandOcean_SH.png',dpi=300)
...
plt.xticks(np.arange(1920,2101,10),np.arange(1920,2101,10))
plt.yticks(np.round(np.arange(0,2.01,0.2),2),np.round(np.arange(0,2.01,0.2),2))
plt.xlim([2015,2100])
plt.ylim([0,1.6])
...
plt.tight_layout()
plt.savefig(directoryfigure + 'TimeSeries_CVmod_GlobeLandOcean_SH.png',dpi=300)
...
plt.tight_layout()
plt.savefig(directoryfigure + 'TimeSeries_difference_LandOcean_SH.png',dpi=300)
