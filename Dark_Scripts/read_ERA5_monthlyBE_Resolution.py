...
Usage
-----
    [1] read_ERA5_monthlyBE_Resolution(variq,directory,sliceperiod,sliceyear,
                  sliceshape,addclimo,slicenan)
"""

def read_ERA5_monthlyBE_Resolution(variq,directory,sliceperiod,sliceyear,sliceshape,addclimo,slicenan):
    """
    ...
    Usage
    -----
    lat,lon,var = read_ERA5_monthlyBE_Resolution(variq,directory,sliceperiod,sliceyear,
                            sliceshape,addclimo,slicenan)
    """
    print('\n>>>>>>>>>> STARTING read_ERA5_monthlyBE_Resolution (Back Extension) function!')
    ...
    ###########################################################################
    ### Parameters
    time = np.arange(1950,2021+1,1)
    monthslice = sliceyear.shape[0]*12
    mon = 12
    
    ###########################################################################
    ### Read in data
    filename = '%s_1950-2021.nc' % variq
    ...
    print('>>>>>>>>>> ENDING read_ERA5_monthlyBE_Resolution (Back Extension) function!')
...
# import calc_Utilities as UT
# variq = 'T2M'
# directory = '/work/Zachary.Labe/Data/ERA5_05x05/monthly/'
# sliceperiod = 'annual'
# sliceyear = np.arange(1950,2021+1,1)
# sliceshape = 3
# slicenan = 'nan'
# addclimo = True
# lat,lon,var = read_ERA5_monthlyBE_Resolution(variq,directory,sliceperiod,
