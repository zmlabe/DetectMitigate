"""
Function(s) reads in monthly data from MIROC6_LE_LOWS for different variables 
using 50 ensemble members for all time periods using SPEAR_LOW resolution
...
Usage
-----
    [1] read_MIROC6_LE_LOWS(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
"""

def read_MIROC6_LE_LOWS(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper):
    """
    Function reads monthly data from MIROC6_LE_LOWS
    ...
    Usage
    -----
    read_MIROC6_LE_LOWS(directory,vari,sliceperiod,sliceshape,
                             slicenan,numOfEns,timeper)
    """
    print('\n>>>>>>>>>> STARTING read_MIROC6_LE_LOWS function!')
    ...
    for i,ensmember in enumerate(ens):
        filename1 = directory + 'MIROC6_LE_LOWS/monthly/%s/%s_%03d_1850-2100.nc' % (vari,vari,
                                                          ensmember)
        ...
        print('Completed: read *MIROC6_LE_LOWS historical* Ensemble Member --%s-- for %s' % (ensmember,vari))
    ...
    del membersvar
    print('Completed: read all MIROC6_LE_LOWS Members!\n')
    ...
    print('>>>>>>>>>> ENDING read_MIROC6_LE_LOWS function!')    
...
# numOfEns = 50
# timeper = 'all'
# lat,lon,var = read_MIROC6_LE_LOWS(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
