...
plt.text(-8,39,r'\textbf{Ridge Regularization [L$_{2}$] -- %s}' % variqname,fontsize=8,color='k',
         ha='left',va='center')  
plt.savefig(directoryfigure + 'MSFigure_ANN_LoopHyperparameters_%s' % (variq),dpi=600)
