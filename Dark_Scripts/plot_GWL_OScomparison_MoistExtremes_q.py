"""
Calculate trend for OS with daily q
...
if varcount == 'count90':
    label = r'\textbf{Count of qx90}' 
elif varcount == 'count95':
    label = r'\textbf{Count of qx95}' 
...
plt.savefig(directoryfigure + 'GWL-%s_MoistExtremes_%s_%s_%s-%s.png' % (selectGWLn,variq,seasons[0],varcount,variq),dpi=300)
