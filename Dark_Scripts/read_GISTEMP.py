...
def read_GISTEMP(directory,sliceperiod,sliceyear,sliceshape,addclimo,slicenan,newon):
    """
    ...
    if newon == False:
        ...
        filename = '%s_GISTEMP_1880-2021.nc' % variq
        ...
        mon = 12
        monthslice = sliceyear.shape[0]*mon
        filename = '%s_GISTEMP_1880-2022.nc' % variq
        data = Dataset(directory + filename,'r')
        lat1 = data.variables['latitude'][:]
        lon1 = data.variables['longitude'][:]
        var = data.variables['%s' % variq][:,:,:]
...
# directory = '/work/Zachary.Labe/Data/GISTEMP'
# sliceperiod = 'FMA'
...
# addclimo = True
# newon = True
# lat,lon,var = read_GISTEMP(directory,sliceperiod,sliceyear,sliceshape,addclimo,slicenan,newon)
