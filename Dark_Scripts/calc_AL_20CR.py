"""
Calculate Aleutian Low Index for 20CRv3
...
for i in range(len(monthsall)):
    ...
    ### Save index
    directoryoutput = '/work/Zachary.Labe/Data/ClimateIndices/AL/'
    np.savetxt(directoryoutput + 'AL-20CRv3_%s_%s_%s-%s_detrended.txt' % (variq,sliceperiod,
                                                                    yearmin,yearmax),np.c_[yearsall,shi])
    print('\n========Calculated AL - %s =======\n' % monthsall[i])
